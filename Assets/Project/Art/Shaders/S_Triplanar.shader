...
Shader "S_Triplanar"
{
	Properties
	{
		...
		[ASEBegin]_TriplanarAlbedo("Triplanar Albedo", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 lerpResult187 = lerp( ase_worldPos , packedInput.ase_texcoord5.xyz , WorldObjectSwitch192);
				...
				surfaceDescription.Albedo = lerpResult105.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult336 = (float2(packedInput.ase_texcoord.xyz.y , packedInput.ase_texcoord.xyz.z));
				...
				float dotResult73 = dot( temp_output_72_0 , float3(1,1,1) );
				float3 BlendComponents147 = ( temp_output_72_0 / dotResult73 );
				float2 appendResult335 = (float2(packedInput.ase_texcoord.xyz.x , packedInput.ase_texcoord.xyz.z));
				float2 appendResult334 = (float2(packedInput.ase_texcoord.xyz.x , packedInput.ase_texcoord.xyz.y));
				float3 ase_worldPos = packedInput.ase_texcoord2.xyz;
				float WorldObjectSwitch192 = _WorldtoObjectSwitch;
				float3 lerpResult187 = lerp( ase_worldPos , packedInput.ase_texcoord.xyz , WorldObjectSwitch192);
				float3 break287 = lerpResult187;
				float2 appendResult333 = (float2(break287.x , break287.z));
				float2 appendResult332 = (float2(packedInput.ase_texcoord.xyz.y , packedInput.ase_texcoord.xyz.z));
				float2 appendResult331 = (float2(packedInput.ase_texcoord.xyz.x , packedInput.ase_texcoord.xyz.z));
				float2 appendResult330 = (float2(packedInput.ase_texcoord.xyz.x , packedInput.ase_texcoord.xyz.y));
				float2 uv_TopNormal = packedInput.ase_texcoord3.xy * _TopNormal_ST.xy + _TopNormal_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float WorldObjectSwitch192 = _WorldtoObjectSwitch;
				float3 lerpResult187 = lerp( ase_worldPos , packedInput.ase_texcoord7.xyz , WorldObjectSwitch192);
				float3 break287 = lerpResult187;
				float2 appendResult333 = (float2(break287.x , break287.z));
...
/*ASEBEGIN
Version=18900
7;70;1920;927;2054.733;-1615.498;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;110;-339.4074,1528.998;Float;False;Property;_CoverageAmount;Coverage Amount;5;0;Create;True;0;0;0;False;0;False;0;0.114;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;348;1799.191,311.382;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;337;1;348;0
WireConnection;337;5;212;0
WireConnection;337;7;213;0
ASEEND*/
//CHKSM=AB7267820ABF6A7232D054A16CCAC3B072E879B2