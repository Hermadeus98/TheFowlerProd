...
Shader "S_Weapons"
{
	Properties
	{
		...
		_E_("E_", 2D) = "white" {}
		_ARM_("ARM_", 2D) = "white" {}
		_E_Intensity("E_ Intensity", Range( 0 , 15)) = 1
		[Toggle]_Nofresnel("No fresnel?", Float) = 0
		[Toggle]_E_Nofresnel("E_No fresnel?", Float) = 1
		_E_Fresnel_Intensity("E_Fresnel_Intensity", Range( 0 , 1)) = 0
		[ASEEnd]_ColorEMISSIVE("Color EMISSIVE", Color) = (0.08080897,0.6037736,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float fresnelNode50 = ( 0.9 + 12.0 * pow( 1.0 - fresnelNdotV50, _FresnelPower ) );
				float2 uv_Fresnel_ = packedInput.ase_texcoord5.xy * _Fresnel__ST.xy + _Fresnel__ST.zw;
				float4 temp_output_54_0 = ( ( ( 1.0 - step( fresnelNode50 , 3.0 ) ) * tex2D( _Fresnel_, uv_Fresnel_ ) ) * _FresnelColor );
				...
				float4 tex2DNode33 = tex2D( _ARM_, uv_ARM_ );
				
				float2 uv_E_ = packedInput.ase_texcoord5.xy * _E__ST.xy + _E__ST.zw;
				float4 temp_output_43_0 = ( ( tex2D( _E_, uv_E_ ) * _ColorEMISSIVE ) * _E_Intensity );
				float4 lerpResult66 = lerp( ( temp_output_43_0 + temp_output_54_0 ) , temp_output_43_0 , _E_Fresnel_Intensity);
				
				surfaceDescription.Albedo = (( _Nofresnel )?( tex2DNode13 ):( ( tex2DNode13 + temp_output_54_0 ) )).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _Normal_, uv_Normal_ ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode33.b;
				...
				surfaceDescription.Smoothness = ( 1.0 - tex2DNode33.g );
				surfaceDescription.Occlusion = tex2DNode33.r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_E_ = packedInput.ase_texcoord.xy * _E__ST.xy + _E__ST.zw;
				float4 temp_output_43_0 = ( ( tex2D( _E_, uv_E_ ) * _ColorEMISSIVE ) * _E_Intensity );
				float4 lerpResult66 = lerp( ( temp_output_43_0 + temp_output_54_0 ) , temp_output_43_0 , _E_Fresnel_Intensity);
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_E_ = packedInput.ase_texcoord7.xy * _E__ST.xy + _E__ST.zw;
				float4 temp_output_43_0 = ( ( tex2D( _E_, uv_E_ ) * _ColorEMISSIVE ) * _E_Intensity );
				float4 lerpResult66 = lerp( ( temp_output_43_0 + temp_output_54_0 ) , temp_output_43_0 , _E_Fresnel_Intensity);
...
/*ASEBEGIN
Version=18900
0;0;1920;1019;1102.309;193.2918;1.966185;True;True
Node;AmplifyShaderEditor.CommentaryNode;45;-893.8445,-1167.004;Inherit;False;1307.11;597.2766;Fresnel;10;53;58;52;57;51;49;50;46;48;47;Fresnel ;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;47;-821.9705,-764.1611;Inherit;False;Property;_FresnelPower;Fresnel Power;3;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-855.0435,-874.5669;Inherit;False;Constant;_FresnelBiais;Fresnel Biais;4;0;Create;True;0;0;0;False;0;False;0.9;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-880.1887,-825.6362;Inherit;False;Constant;_FresnelScale;Fresnel Scale;8;0;Create;True;0;0;0;False;0;False;12;125;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;-437.2987,-704.8953;Inherit;False;Constant;_FresnelStep;Fresnel Step;11;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;51;-373.4354,-897.7814;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;28;-138.4648,1279.432;Inherit;False;1101.116;667.9636;Emissive;5;67;43;34;40;68;Emissive;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;34;-27.67427,1348.572;Inherit;True;Property;_E_;E_;5;0;Create;True;0;0;0;False;0;False;-1;70bd977c1ae7bc74b84ac46de1041d78;8bb7c9a3b9172bc4d9befc7864227282;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;68;100.9183,1227.3;Inherit;False;Property;_ColorEMISSIVE;Color EMISSIVE;11;0;Create;True;0;0;0;False;0;False;0.08080897,0.6037736,0,0;0.3607843,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;67;366.2338,1343.535;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;40;331.6264,1565.953;Inherit;False;Property;_E_Intensity;E_ Intensity;7;0;Create;True;0;0;0;False;0;False;1;6.46;0;15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;53;63.25855,-870.5869;Inherit;False;Property;_FresnelColor;Fresnel Color;2;0;Create;True;0;0;0;False;0;False;0.5849056,0.4589195,0.1903702,1;0.5849056,0.4589193,0.1903701,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;11;-611.2979,-206.2701;Inherit;False;951.7336;567.918;Diffuse;12;13;33;6;9;3;5;8;4;10;1;2;7;Color Diffuse;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;43;665.0371,1433.985;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;664.652,982.9872;Inherit;False;Property;_E_Fresnel_Intensity;E_Fresnel_Intensity;10;0;Create;True;0;0;0;False;0;False;0;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-94.83334,84.5432;Inherit;True;Property;_Diffuse_;Diffuse_;1;0;Create;True;0;0;0;False;0;False;-1;794827149dd2931478dfdff3f40f2564;a8b6ba33d0dc1434f8460a502f6276a4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;23;-515.9899,762.9993;Inherit;False;703.1268;359.7476;Normal;1;24;Normal;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;55;859.4866,-299.4173;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;33;-110.9386,-118.8192;Inherit;True;Property;_ARM_;ARM_;6;0;Create;True;0;0;0;False;0;False;-1;2c1b3d529a43e684ea06dcb08ecd5505;0705be03825f87f48a5161241f9f6ef8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-446.388,812.9993;Inherit;True;Property;_Normal_;Normal_;4;0;Create;True;0;0;0;False;0;False;-1;089eaf2098e971c408ab8076f6f9b428;089eaf2098e971c408ab8076f6f9b428;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;56;1320.084,-159.641;Inherit;False;Property;_Nofresnel;No fresnel?;8;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;44;426.7592,249.7233;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;59;1437.96,995.8848;Inherit;False;Property;_E_Nofresnel;E_No fresnel?;9;0;Create;True;0;0;0;False;0;False;1;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
