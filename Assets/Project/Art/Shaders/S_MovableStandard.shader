...
Shader "S_MovableStandard"
{
	Properties
	{
		...
		_E_Intensity2("E_ Intensity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_1 = (_Tiling2).xx;
				float2 texCoord13 = packedInput.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				float4 temp_output_17_0 = ( tex2D( _Diffuse_2, texCoord13 ) * _DIntensity2 );
				float3 temp_output_1_0_g7 = temp_output_17_0.rgb;
				...
				float4 lerpResult30 = lerp( appendResult24_g7 , temp_output_17_0 , _BaseColorAlpha2);
				float3 temp_output_5_0_g8 = lerpResult30.rgb;
				float3 rotatedValue1_g8 = RotateAroundAxis( temp_cast_0, temp_output_5_0_g8, normalizeResult2_g8, _HueShift2 );
				
				float3 tex2DNode23 = UnpackNormalScale( tex2D( _Normal_2, texCoord13 ), 1.0f );
				float3 break31 = tex2DNode23;
				float4 appendResult44 = (float4(break31.x , ( 1.0 - break31.y ) , break31.z , 0.0));
				#ifdef _SWITCHNORMALAXIS1_ON
				float4 staticSwitch48 = appendResult44;
				#else
				float4 staticSwitch48 = float4( tex2DNode23 , 0.0 );
				#endif
				float3 break7_g9 = staticSwitch48.xyz;
				...
				float4 tex2DNode45 = tex2D( _ARM_2, texCoord13 );
				float clampResult55 = clamp( tex2DNode45.b , _MetalMin2 , _MetalMax2 );
				
				float clampResult50 = clamp( tex2DNode45.g , _RoughnessMin2 , _RoughnessMax2 );
				
				surfaceDescription.Albedo = ( rotatedValue1_g8 + temp_output_5_0_g8 );
				surfaceDescription.Normal = appendResult3_g9.xyz;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = clampResult55;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( tex2D( _E_2, texCoord13 ) * _E_Intensity2 ).rgb;
				surfaceDescription.Smoothness = ( 1.0 - clampResult50 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 temp_cast_0 = (0.0).xxx;
				float2 temp_cast_1 = (_Tiling2).xx;
				float2 texCoord13 = packedInput.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				float4 temp_output_17_0 = ( tex2D( _Diffuse_2, texCoord13 ) * _DIntensity2 );
				float3 temp_output_1_0_g7 = temp_output_17_0.rgb;
				float3 temp_output_2_0_g7 = _ColorOverlay2.rgb;
				float3 temp_output_8_0_g7 = ( 1.0 - ( ( ( 1.0 - temp_output_1_0_g7 ) * float3( 2,2,2 ) ) * ( 1.0 - temp_output_2_0_g7 ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_cast_0 = (_Tiling2).xx;
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_cast_0 = (0.0).xxx;
				float2 temp_cast_1 = (_Tiling2).xx;
				float2 texCoord13 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float4 temp_output_17_0 = ( tex2D( _Diffuse_2, texCoord13 ) * _DIntensity2 );
				float3 temp_output_1_0_g7 = temp_output_17_0.rgb;
				float3 temp_output_2_0_g7 = _ColorOverlay2.rgb;
				float3 temp_output_8_0_g7 = ( 1.0 - ( ( ( 1.0 - temp_output_1_0_g7 ) * float3( 2,2,2 ) ) * ( 1.0 - temp_output_2_0_g7 ) ) );
...
/*ASEBEGIN
Version=18900
688;-3;1296;1026;3130.652;1346.503;3.244758;True;True
Node;AmplifyShaderEditor.RangedFloatNode;11;-1897.337,-276.2271;Inherit;False;Property;_Tiling2;Tiling;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-1682.27,-215.4549;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;19;-817.7682,920.5638;Inherit;False;703.1268;359.7476;Normal;5;51;44;34;31;23;Normal;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;12;-1213.752,-624.0877;Inherit;False;1544.728;563.7712;Diffuse;9;37;30;28;27;25;21;17;15;14;Color Diffuse;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;23;-748.1663,970.5638;Inherit;True;Property;_Normal_2;Normal_;4;0;Create;True;0;0;0;False;0;False;-1;089eaf2098e971c408ab8076f6f9b428;86cbc2a86a96cde4f940c2521178061a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.BreakToComponentsNode;31;-431.6176,1104.012;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SamplerNode;15;-1163.752,-429.1728;Inherit;True;Property;_Diffuse_2;Diffuse_;0;0;Create;True;0;0;0;False;0;False;-1;794827149dd2931478dfdff3f40f2564;aa37296471d85d548b821d64927dd473;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-848.8635,-536.0115;Inherit;False;Property;_DIntensity2;_D Intensity;13;0;Create;True;0;0;0;False;0;False;1;1;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;-829.4426,-272.3163;Inherit;False;Property;_ColorOverlay2;Color Overlay;5;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;35;-507.4751,171.4729;Inherit;False;647.9473;337.8428;Roughness;4;57;50;43;41;Roughness;1,1,1,1;0;0
Node;AmplifyShaderEditor.OneMinusNode;34;-312.6174,1081.912;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-812.3446,-427.7232;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;45;-992.1093,188.6699;Inherit;True;Property;_ARM_2;ARM_;7;0;Create;True;0;0;0;False;0;False;-1;2c1b3d529a43e684ea06dcb08ecd5505;15114a941965be749b6144376cb5d7be;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;41;-457.4751,314.3169;Inherit;False;Property;_RoughnessMin2;Roughness Min;14;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-450.4212,393.3169;Inherit;False;Property;_RoughnessMax2;Roughness Max;15;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;25;-604.2884,-361.3;Inherit;False;SF_BlendOverlay;1;;7;a1dec649ed25eac4fae42eb57593d204;0;2;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.CommentaryNode;39;-636.2553,1404.683;Inherit;False;950.1268;310.0334;Emissive;3;56;53;47;Emissive;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;40;-561.4213,516.7708;Inherit;False;552.493;269.212;Metal;3;55;52;49;Metal;1,1,1,1;0;0
Node;AmplifyShaderEditor.DynamicAppendNode;44;-199.3176,1125.412;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-610.8826,-206.0456;Inherit;False;Property;_BaseColorAlpha2;Base Color Alpha;10;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-470.0307,-494.4078;Inherit;False;Property;_HueShift2;HueShift;11;0;Create;True;0;0;0;False;0;False;0;0;0;180;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;30;-376.6972,-369.4485;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-511.4212,566.7708;Inherit;False;Property;_MetalMin2;Metal Min;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;50;-190.8468,285.0179;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-767.7682,1164.312;Inherit;False;Property;_NormalIntensity2;NormalIntensity;12;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-508.9925,669.9839;Inherit;False;Property;_MetalMax2;Metal Max;18;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-227.3686,1598.716;Inherit;False;Property;_E_Intensity2;E_ Intensity;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;48;-53.9176,973.3116;Inherit;False;Property;_SwitchNormalAxis1;Switch Normal Axis;17;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;47;-525.4648,1473.823;Inherit;True;Property;_E_2;E_;6;0;Create;True;0;0;0;False;0;False;-1;70bd977c1ae7bc74b84ac46de1041d78;70bd977c1ae7bc74b84ac46de1041d78;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;57;-38.52789,221.4729;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;37;-171.0047,-377.3362;Inherit;False;SF_HueShift;-1;;8;0948a3b5688578f439e58e02283161d5;0;2;5;FLOAT3;0,0,0;False;7;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;54;197.7585,1078.661;Inherit;False;SF_NIntensity;-1;;9;817744208f9670f4b9afc355813a090c;0;2;6;FLOAT3;0,0,0;False;8;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ClampOpNode;55;-179.9281,595.9128;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;56;151.8712,1454.683;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;37;5;30;0
WireConnection;37;7;28;0
WireConnection;54;6;48;0
WireConnection;54;8;51;0
...
ASEEND*/
//CHKSM=10B96D6A4554AF326E8356F432F037F1CFB2BFC7