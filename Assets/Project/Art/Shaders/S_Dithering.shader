...
Shader "S_Dithering"
{
	Properties
	{
		...
		[ASEEnd]_MaskClipValue("Mask Clip Value", Float) = 0.74
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.Albedo = tex2D( _Albedo, uv_Albedo ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _Normal, uv_Albedo ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = tex2D( _Specular, uv_Albedo ).rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = tex2D( _Occlusion, uv_Albedo ).r;
				surfaceDescription.Alpha = saturate( ( ( ( eyeDepth + -temp_output_65_0 ) / ( _EndDitheringFade - temp_output_65_0 ) ) - dither26 ) );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objectToViewPos = TransformWorldToView(TransformObjectToWorld(inputMesh.positionOS));
				float eyeDepth = -objectToViewPos.z;
				outputPackedVaryingsMeshToPS.ase_texcoord1.x = eyeDepth;
				float4 ase_clipPos = TransformWorldToHClip( TransformObjectToWorld(inputMesh.positionOS));
				float4 screenPos = ComputeScreenPos( ase_clipPos , _ProjectionParams.x );
				...
				//setting value to unused interpolator channels and avoid initialization warnings
				outputPackedVaryingsMeshToPS.ase_texcoord1.yzw = 0;
...
/*ASEBEGIN
Version=18900
7;70;1920;927;1882.693;430.2313;2.474713;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-584.0002,374.09;Float;False;Property;_StartDitheringFade;Start Dithering Fade;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-117.5356,335.0947;Float;False;Property;_EndDitheringFade;End Dithering Fade;5;0;Create;True;0;0;0;False;0;False;1;3.65;0;0;0;1;FLOAT;0
...
WireConnection;85;0;27;0
WireConnection;73;0;52;0
WireConnection;73;1;51;0
WireConnection;73;5;67;0
WireConnection;73;8;49;0
WireConnection;73;9;85;0
WireConnection;73;10;84;0
ASEEND*/
//CHKSM=03844BBE13DD0B2EFC06D660159F04F44AFF572E