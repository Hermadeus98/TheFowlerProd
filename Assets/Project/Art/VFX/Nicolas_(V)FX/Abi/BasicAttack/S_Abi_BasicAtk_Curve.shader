...
Shader "S_Abi_BasicAtk_Curve"
{
	Properties
	{
		...
		[ASEEnd][Toggle]_Soulercoaster_InvertUV("Soulercoaster_InvertUV", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float mulTime1_g51 = _TimeParameters.x * _Flicker_Speed;
				float temp_output_2_0_g51 = sin( ( mulTime1_g51 + ( 0.0 * _Flicker_Offset ) ) );
				float lerpResult12_g51 = lerp( _Flicker_Min , _Flicker_Max , ( ( temp_output_2_0_g51 + 1.0 ) / 2.0 ));
				...
				float2 temp_output_1_0_g47 = texCoord9_g44;
				...
				float2 panner1_g45 = ( ( floor( ( _TimeParameters.x * _TimeStep ) ) / _TimeStep ) * (lerpResult2_g46).xy + ( (lerpResult2_g47).xy * (lerpResult2_g48).xy ));
				float4 temp_output_22_0 = tex2D( _PanningTex, ( ( float4( float2( 0,0 ), 0.0 , 0.0 ) + lerpResult41_g44 ).xy + panner1_g45 ), ddx( texCoord9_g44 ), ddy( texCoord9_g44 ) );
				float smoothstepResult5_g50 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , temp_output_22_0.r);
				float lerpResult12_g50 = lerp( smoothstepResult5_g50 , ( 1.0 - smoothstepResult5_g50 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g50 = lerp( _ColorA , _ColorB , lerpResult12_g50);
				
				float2 texCoord7_g43 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g43 = frac( texCoord7_g43 );
				float smoothstepResult3_g43 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g43.x);
				float smoothstepResult4_g43 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g43.x ));
				float smoothstepResult5_g43 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g43.y);
				float smoothstepResult6_g43 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g43.y ));
				float lerpResult14_g43 = lerp( 1.0 , ( smoothstepResult3_g43 * smoothstepResult4_g43 * smoothstepResult5_g43 * smoothstepResult6_g43 ) , _EdgeFade_Enable);
				float2 texCoord28_g49 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g49 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g49 = appendResult48_g49;
				float4 texCoord24 = packedInput.ase_texcoord1;
				texCoord24.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_31_0_g49 = ( texCoord24.z + _Soulercoaster_DebugPan );
				float2 appendResult38_g49 = (float2(temp_output_31_0_g49 , 0.0));
				float2 appendResult39_g49 = (float2(0.0 , temp_output_31_0_g49));
				float2 lerpResult40_g49 = lerp( appendResult38_g49 , appendResult39_g49 , _Soulercoaster_InvertPanUV);
				float2 temp_output_42_0_g49 = ( ( ( _PanningAlphaTex_ST.xy * ( texCoord28_g49 - temp_output_25_0_g49 ) ) + temp_output_25_0_g49 ) + lerpResult40_g49 );
				float2 lerpResult43_g49 = lerp( temp_output_42_0_g49 , (temp_output_42_0_g49).yx , _Soulercoaster_InvertUV);
				
				surfaceDescription.Color = ( lerpResult12_g51 * lerpResult4_g50 * packedInput.ase_color ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( lerpResult14_g43 * tex2D( _PanningAlphaTex, lerpResult43_g49 ).r * temp_output_22_0 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord7_g43 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g43 = frac( texCoord7_g43 );
				float smoothstepResult3_g43 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g43.x);
				float smoothstepResult4_g43 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g43.x ));
				float smoothstepResult5_g43 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g43.y);
				float smoothstepResult6_g43 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g43.y ));
				float lerpResult14_g43 = lerp( 1.0 , ( smoothstepResult3_g43 * smoothstepResult4_g43 * smoothstepResult5_g43 * smoothstepResult6_g43 ) , _EdgeFade_Enable);
				float2 texCoord28_g49 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g49 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g49 = appendResult48_g49;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord7_g43 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g43 = frac( texCoord7_g43 );
				float smoothstepResult3_g43 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g43.x);
				float smoothstepResult4_g43 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g43.x ));
				float smoothstepResult5_g43 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g43.y);
				float smoothstepResult6_g43 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g43.y ));
				float lerpResult14_g43 = lerp( 1.0 , ( smoothstepResult3_g43 * smoothstepResult4_g43 * smoothstepResult5_g43 * smoothstepResult6_g43 ) , _EdgeFade_Enable);
				float2 texCoord28_g49 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g49 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g49 = appendResult48_g49;
				...
				float4 appendResult5_g46 = (float4(break3_g46.y , break3_g46.x , 0.0 , 0.0));
				float4 lerpResult2_g46 = lerp( float4( temp_output_1_0_g46, 0.0 , 0.0 ) , appendResult5_g46 , _PanningTex_InvertUV);
				float2 texCoord9_g44 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g47 = texCoord9_g44;
				float2 break3_g47 = temp_output_1_0_g47;
				float4 appendResult5_g47 = (float4(break3_g47.y , break3_g47.x , 0.0 , 0.0));
				float4 lerpResult2_g47 = lerp( float4( temp_output_1_0_g47, 0.0 , 0.0 ) , appendResult5_g47 , _PanningTex_InvertUV);
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;1071.61;581.3528;1;True;False
Node;AmplifyShaderEditor.FunctionNode;20;-819.61,-206.3528;Inherit;False;SF_SteppedTime;16;;42;acd127cf8f86d3d47a5b97e56cc9ba1d;0;1;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;9;-593.6102,60.64719;Inherit;False;SF_EdgeFade;24;;43;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;22;-573.6102,-276.3528;Inherit;False;SF_PanningTexture;0;;44;b045855c7f4c7344eb8723194efc0969;0;7;3;SAMPLER2D;;False;46;FLOAT;0;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;21;-710,139.5;Inherit;False;SF_SoulercoasterAlpha;29;;49;17e687cf74ec1c14fba2843a0e8105d3;0;3;25;FLOAT2;0,0;False;27;FLOAT2;0,0;False;30;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;12;-15.60999,-69.35281;Inherit;False;SF_Bicolor;18;;50;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;23;42.39001,-199.3528;Inherit;False;SF_Flicker;10;;51;15da182ec18f26346a4a9baee3c35498;0;1;7;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;25;-169.61,-403.3528;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-399.61,56.64719;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;271.39,-120.3528;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=435BE004CBED53A5E8CC5F4866990D0429C75440