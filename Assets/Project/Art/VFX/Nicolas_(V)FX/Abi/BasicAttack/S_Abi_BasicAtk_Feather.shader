...
Shader "S_Abi_BasicAtk_Feather"
{
	Properties
	{
		...
		[Header(PanningAlpha)]_PanningAlphaTex("PanningAlphaTex", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 appendResult36 = (float2(0.0 , texCoord24.w));
				float4 appendResult43_g75 = (float4(0.0 , _PanningTex_ManualOffset , 0.0 , 0.0));
				float4 appendResult42_g75 = (float4(_PanningTex_ManualOffset , 0.0 , 0.0 , 0.0));
				float4 lerpResult41_g75 = lerp( appendResult43_g75 , appendResult42_g75 , _PanningTex_InvertUV);
				float2 temp_output_1_0_g77 = _PanningTex_ST.zw;
				float2 break3_g77 = temp_output_1_0_g77;
				float4 appendResult5_g77 = (float4(break3_g77.y , break3_g77.x , 0.0 , 0.0));
				float4 lerpResult2_g77 = lerp( float4( temp_output_1_0_g77, 0.0 , 0.0 ) , appendResult5_g77 , _PanningTex_InvertUV);
				float2 texCoord29 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord13_g71 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g72 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g71 * _DistortTex_ST.xy ));
				float4 temp_cast_3 = (1.0).xxxx;
				float2 temp_output_1_0_g78 = ( texCoord29 + (( ( ( tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g72 ) ) * 2.0 ) - temp_cast_3 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg );
				float2 break3_g78 = temp_output_1_0_g78;
				float4 appendResult5_g78 = (float4(break3_g78.y , break3_g78.x , 0.0 , 0.0));
				float4 lerpResult2_g78 = lerp( float4( temp_output_1_0_g78, 0.0 , 0.0 ) , appendResult5_g78 , _PanningTex_InvertUV);
				float2 temp_output_1_0_g79 = ( _PanningTex_ST.xy * float2( 1,1 ) );
				float2 break3_g79 = temp_output_1_0_g79;
				float4 appendResult5_g79 = (float4(break3_g79.y , break3_g79.x , 0.0 , 0.0));
				float4 lerpResult2_g79 = lerp( float4( temp_output_1_0_g79, 0.0 , 0.0 ) , appendResult5_g79 , _PanningTex_InvertUV);
				float2 panner1_g76 = ( _TimeParameters.x * (lerpResult2_g77).xy + ( (lerpResult2_g78).xy * (lerpResult2_g79).xy ));
				float2 texCoord9_g75 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_22_0 = tex2D( _PanningTex, ( ( float4( appendResult36, 0.0 , 0.0 ) + lerpResult41_g75 ).xy + panner1_g76 ), ddx( texCoord9_g75 ), ddy( texCoord9_g75 ) );
				float smoothstepResult5_g82 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , temp_output_22_0.r);
				float lerpResult12_g82 = lerp( smoothstepResult5_g82 , ( 1.0 - smoothstepResult5_g82 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g82 = lerp( _ColorA , _ColorB , lerpResult12_g82);
				
				float temp_output_7_0_g81 = ( _AlphaThreshold + 0.0 );
				float2 texCoord7_g73 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g73 = frac( texCoord7_g73 );
				float smoothstepResult3_g73 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g73.x);
				float smoothstepResult4_g73 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g73.x ));
				float smoothstepResult5_g73 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g73.y);
				float smoothstepResult6_g73 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g73.y ));
				float lerpResult14_g73 = lerp( 1.0 , ( smoothstepResult3_g73 * smoothstepResult4_g73 * smoothstepResult5_g73 * smoothstepResult6_g73 ) , _EdgeFade_Enable);
				float2 texCoord28_g74 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g74 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g74 = appendResult48_g74;
				float temp_output_31_0_g74 = ( texCoord24.z + _Soulercoaster_DebugPan );
				float2 appendResult38_g74 = (float2(temp_output_31_0_g74 , 0.0));
				float2 appendResult39_g74 = (float2(0.0 , temp_output_31_0_g74));
				float2 lerpResult40_g74 = lerp( appendResult38_g74 , appendResult39_g74 , _Soulercoaster_InvertPanUV);
				float2 temp_output_42_0_g74 = ( ( ( _PanningAlphaTex_ST.xy * ( texCoord28_g74 - temp_output_25_0_g74 ) ) + temp_output_25_0_g74 ) + lerpResult40_g74 );
				float2 lerpResult43_g74 = lerp( temp_output_42_0_g74 , (temp_output_42_0_g74).yx , _Soulercoaster_InvertUV);
				float lerpResult1_g80 = lerp( ( lerpResult14_g73 * tex2D( _PanningAlphaTex, lerpResult43_g74 ).r ) , temp_output_22_0.r , _AlphaLerp_TexInfluence);
				float temp_output_1_0_g81 = lerpResult1_g80;
				float lerpResult9_g81 = lerp( temp_output_1_0_g81 , ( 1.0 - temp_output_1_0_g81 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g81 = smoothstep( temp_output_7_0_g81 , ( temp_output_7_0_g81 + _AlphaSmoothness ) , lerpResult9_g81);
				
				surfaceDescription.Color = ( packedInput.ase_color * lerpResult4_g82 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( smoothstepResult2_g81 * packedInput.ase_color.a );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float temp_output_7_0_g81 = ( _AlphaThreshold + 0.0 );
				float2 texCoord7_g73 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g73 = frac( texCoord7_g73 );
				float smoothstepResult3_g73 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g73.x);
				float smoothstepResult4_g73 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g73.x ));
				float smoothstepResult5_g73 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g73.y);
				float smoothstepResult6_g73 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g73.y ));
				float lerpResult14_g73 = lerp( 1.0 , ( smoothstepResult3_g73 * smoothstepResult4_g73 * smoothstepResult5_g73 * smoothstepResult6_g73 ) , _EdgeFade_Enable);
				float2 texCoord28_g74 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g74 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g74 = appendResult48_g74;
				...
				float4 appendResult5_g77 = (float4(break3_g77.y , break3_g77.x , 0.0 , 0.0));
				float4 lerpResult2_g77 = lerp( float4( temp_output_1_0_g77, 0.0 , 0.0 ) , appendResult5_g77 , _PanningTex_InvertUV);
				float2 texCoord29 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord13_g71 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g72 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g71 * _DistortTex_ST.xy ));
				float4 temp_cast_3 = (1.0).xxxx;
				float2 temp_output_1_0_g78 = ( texCoord29 + (( ( ( tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g72 ) ) * 2.0 ) - temp_cast_3 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg );
				float2 break3_g78 = temp_output_1_0_g78;
				...
				float4 lerpResult2_g79 = lerp( float4( temp_output_1_0_g79, 0.0 , 0.0 ) , appendResult5_g79 , _PanningTex_InvertUV);
				float2 panner1_g76 = ( _TimeParameters.x * (lerpResult2_g77).xy + ( (lerpResult2_g78).xy * (lerpResult2_g79).xy ));
				float2 texCoord9_g75 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_22_0 = tex2D( _PanningTex, ( ( float4( appendResult36, 0.0 , 0.0 ) + lerpResult41_g75 ).xy + panner1_g76 ), ddx( texCoord9_g75 ), ddy( texCoord9_g75 ) );
				float lerpResult1_g80 = lerp( ( lerpResult14_g73 * tex2D( _PanningAlphaTex, lerpResult43_g74 ).r ) , temp_output_22_0.r , _AlphaLerp_TexInfluence);
				float temp_output_1_0_g81 = lerpResult1_g80;
				float lerpResult9_g81 = lerp( temp_output_1_0_g81 , ( 1.0 - temp_output_1_0_g81 ) , _AlphaSharp_OneMinus);
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float temp_output_7_0_g81 = ( _AlphaThreshold + 0.0 );
				float2 texCoord7_g73 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g73 = frac( texCoord7_g73 );
				float smoothstepResult3_g73 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g73.x);
				float smoothstepResult4_g73 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g73.x ));
				float smoothstepResult5_g73 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g73.y);
				float smoothstepResult6_g73 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g73.y ));
				float lerpResult14_g73 = lerp( 1.0 , ( smoothstepResult3_g73 * smoothstepResult4_g73 * smoothstepResult5_g73 * smoothstepResult6_g73 ) , _EdgeFade_Enable);
				float2 texCoord28_g74 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g74 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g74 = appendResult48_g74;
				...
				float4 appendResult5_g77 = (float4(break3_g77.y , break3_g77.x , 0.0 , 0.0));
				float4 lerpResult2_g77 = lerp( float4( temp_output_1_0_g77, 0.0 , 0.0 ) , appendResult5_g77 , _PanningTex_InvertUV);
				float2 texCoord29 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord13_g71 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g72 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g71 * _DistortTex_ST.xy ));
				float4 temp_cast_3 = (1.0).xxxx;
				float2 temp_output_1_0_g78 = ( texCoord29 + (( ( ( tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g72 ) ) * 2.0 ) - temp_cast_3 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg );
				float2 break3_g78 = temp_output_1_0_g78;
				...
				float4 lerpResult2_g79 = lerp( float4( temp_output_1_0_g79, 0.0 , 0.0 ) , appendResult5_g79 , _PanningTex_InvertUV);
				float2 panner1_g76 = ( _TimeParameters.x * (lerpResult2_g77).xy + ( (lerpResult2_g78).xy * (lerpResult2_g79).xy ));
				float2 texCoord9_g75 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_22_0 = tex2D( _PanningTex, ( ( float4( appendResult36, 0.0 , 0.0 ) + lerpResult41_g75 ).xy + panner1_g76 ), ddx( texCoord9_g75 ), ddy( texCoord9_g75 ) );
				float lerpResult1_g80 = lerp( ( lerpResult14_g73 * tex2D( _PanningAlphaTex, lerpResult43_g74 ).r ) , temp_output_22_0.r , _AlphaLerp_TexInfluence);
				float temp_output_1_0_g81 = lerpResult1_g80;
				float lerpResult9_g81 = lerp( temp_output_1_0_g81 , ( 1.0 - temp_output_1_0_g81 ) , _AlphaSharp_OneMinus);
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;1828.921;739.9746;1.3;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;24;-1079.61,122.6472;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;29;-1153.104,-408.3773;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;33;-1277.104,-250.3773;Inherit;False;SF_DistortTexture;0;;71;96c99f2862d31594fbaa887784570dd8;0;3;16;FLOAT;0;False;17;FLOAT;1;False;11;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;21;-710,139.5;Inherit;False;SF_SoulercoasterAlpha;19;;74;17e687cf74ec1c14fba2843a0e8105d3;0;3;25;FLOAT2;0,0;False;27;FLOAT2;0,0;False;30;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;36;-797.5374,-155.7693;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-910.1036,-306.3773;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;9;-593.6102,60.64719;Inherit;False;SF_EdgeFade;25;;73;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-365.31,93.34718;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;22;-573.6102,-276.3528;Inherit;False;SF_PanningTexture;3;;75;b045855c7f4c7344eb8723194efc0969;0;7;3;SAMPLER2D;;False;46;FLOAT;0;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;27;-109.4003,124.416;Inherit;False;SF_AlphaLerp;30;;80;853a1742ead4a334f9e5c5176cca2294;0;2;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;34;142.4371,160.419;Inherit;False;SF_AlphaSharp;32;;81;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;25;-169.61,-403.3528;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;464.2454,98.87799;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;302.0466,-151.5667;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;12;-15.60999,-69.35281;Inherit;False;SF_Bicolor;13;;82;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;21;30;24;3
WireConnection;36;1;24;4
WireConnection;30;0;29;0
WireConnection;30;1;33;0
WireConnection;13;0;9;0
WireConnection;13;1;21;0
WireConnection;22;5;30;0
WireConnection;22;8;36;0
WireConnection;27;2;13;0
WireConnection;27;3;22;0
WireConnection;34;1;27;0
WireConnection;35;0;34;0
WireConnection;35;1;25;4
...
ASEEND*/
//CHKSM=A988A71917402CEB65D847DFABEE74D297C97FCE