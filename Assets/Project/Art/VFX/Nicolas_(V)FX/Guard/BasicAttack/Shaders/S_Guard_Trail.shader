...
Shader "S_Guard_Trail"
{
	Properties
	{
		...
		_VertexColorStrength("VertexColorStrength", Float) = 3
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexPos1_g52 = inputMesh.positionOS;
				float4 ase_clipPos1_g52 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g52));
				float4 screenPos1_g52 = ComputeScreenPos( ase_clipPos1_g52 , _ProjectionParams.x );
				o.ase_texcoord2 = screenPos1_g52;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 temp_output_1_0_g46 = _PanningTex_ST.zw;
				...
				float2 texCoord13_g42 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g43 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g42 * _DistortTex_ST.xy ));
				float4 temp_cast_3 = (1.0).xxxx;
				float2 texCoord9 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g47 = ( (( ( ( tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g43 ) ) * 2.0 ) - temp_cast_3 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg + texCoord9 );
				...
				float2 temp_output_1_0_g48 = ( _PanningTex_ST.xy * float2( 1,1 ) );
				...
				float2 panner1_g45 = ( _TimeParameters.x * (lerpResult2_g46).xy + ( (lerpResult2_g47).xy * (lerpResult2_g48).xy ));
				float2 texCoord9_g44 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_7_0 = tex2D( _PanningTex, ( ( float4( float2( 0,0 ), 0.0 , 0.0 ) + lerpResult41_g44 ).xy + panner1_g45 ), ddx( texCoord9_g44 ), ddy( texCoord9_g44 ) );
				...
				float4 screenPos1_g52 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm1 = screenPos1_g52 / screenPos1_g52.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g52 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g52 = saturate( abs( ( screenDepth1_g52 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g52 = lerp( distanceDepth1_g52 , ( 1.0 - distanceDepth1_g52 ) , _DF_OneMinus);
				float temp_output_7_0_g51 = ( _AlphaThreshold + 0.0 );
				float temp_output_1_0_g51 = temp_output_7_0.r;
				float lerpResult9_g51 = lerp( temp_output_1_0_g51 , ( 1.0 - temp_output_1_0_g51 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g51 = smoothstep( temp_output_7_0_g51 , ( temp_output_7_0_g51 + _AlphaSmoothness ) , lerpResult9_g51);
				...
				float4 temp_output_13_0 = ( lerpResult14_g41 * temp_output_7_0 * packedInput.ase_color.a );
				
				surfaceDescription.Color = ( lerpResult4_g49 + ( packedInput.ase_color * _VertexColorStrength ) ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( lerpResult3_g52 * smoothstepResult2_g51 * temp_output_13_0 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 screenPos1_g52 = packedInput.ase_texcoord;
				float4 ase_screenPosNorm1 = screenPos1_g52 / screenPos1_g52.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g52 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g52 = saturate( abs( ( screenDepth1_g52 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float4 ase_clipPos1_g52 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g52));
				float4 screenPos1_g52 = ComputeScreenPos( ase_clipPos1_g52 , _ProjectionParams.x );
				o.ase_texcoord1 = screenPos1_g52;
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 appendResult5_g46 = (float4(break3_g46.y , break3_g46.x , 0.0 , 0.0));
				float4 lerpResult2_g46 = lerp( float4( temp_output_1_0_g46, 0.0 , 0.0 ) , appendResult5_g46 , _PanningTex_InvertUV);
				float2 texCoord13_g42 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g43 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g42 * _DistortTex_ST.xy ));
				float4 temp_cast_3 = (1.0).xxxx;
				...
				float4 lerpResult2_g48 = lerp( float4( temp_output_1_0_g48, 0.0 , 0.0 ) , appendResult5_g48 , _PanningTex_InvertUV);
				float2 panner1_g45 = ( _TimeParameters.x * (lerpResult2_g46).xy + ( (lerpResult2_g47).xy * (lerpResult2_g48).xy ));
				float2 texCoord9_g44 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_7_0 = tex2D( _PanningTex, ( ( float4( float2( 0,0 ), 0.0 , 0.0 ) + lerpResult41_g44 ).xy + panner1_g45 ), ddx( texCoord9_g44 ), ddy( texCoord9_g44 ) );
				float smoothstepResult5_g49 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , temp_output_7_0.r);
				float lerpResult12_g49 = lerp( smoothstepResult5_g49 , ( 1.0 - smoothstepResult5_g49 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g49 = lerp( _ColorA , _ColorB , lerpResult12_g49);
				
				float4 screenPos1_g52 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm1 = screenPos1_g52 / screenPos1_g52.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g52 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g52 = saturate( abs( ( screenDepth1_g52 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				float4 ase_clipPos1_g52 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g52));
				float4 screenPos1_g52 = ComputeScreenPos( ase_clipPos1_g52 , _ProjectionParams.x );
				o.ase_texcoord3 = screenPos1_g52;
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 screenPos1_g52 = packedInput.ase_texcoord3;
				float4 ase_screenPosNorm1 = screenPos1_g52 / screenPos1_g52.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g52 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g52 = saturate( abs( ( screenDepth1_g52 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				...
				float4 appendResult5_g46 = (float4(break3_g46.y , break3_g46.x , 0.0 , 0.0));
				float4 lerpResult2_g46 = lerp( float4( temp_output_1_0_g46, 0.0 , 0.0 ) , appendResult5_g46 , _PanningTex_InvertUV);
				float2 texCoord13_g42 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g43 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g42 * _DistortTex_ST.xy ));
				float4 temp_cast_3 = (1.0).xxxx;
				float2 texCoord9 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g47 = ( (( ( ( tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g43 ) ) * 2.0 ) - temp_cast_3 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg + texCoord9 );
				float2 break3_g47 = temp_output_1_0_g47;
				float4 appendResult5_g47 = (float4(break3_g47.y , break3_g47.x , 0.0 , 0.0));
				float4 lerpResult2_g47 = lerp( float4( temp_output_1_0_g47, 0.0 , 0.0 ) , appendResult5_g47 , _PanningTex_InvertUV);
				...
				float4 lerpResult2_g48 = lerp( float4( temp_output_1_0_g48, 0.0 , 0.0 ) , appendResult5_g48 , _PanningTex_InvertUV);
				float2 panner1_g45 = ( _TimeParameters.x * (lerpResult2_g46).xy + ( (lerpResult2_g47).xy * (lerpResult2_g48).xy ));
				float2 texCoord9_g44 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_7_0 = tex2D( _PanningTex, ( ( float4( float2( 0,0 ), 0.0 , 0.0 ) + lerpResult41_g44 ).xy + panner1_g45 ), ddx( texCoord9_g44 ), ddy( texCoord9_g44 ) );
				float temp_output_1_0_g51 = temp_output_7_0.r;
				float lerpResult9_g51 = lerp( temp_output_1_0_g51 , ( 1.0 - temp_output_1_0_g51 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g51 = smoothstep( temp_output_7_0_g51 , ( temp_output_7_0_g51 + _AlphaSmoothness ) , lerpResult9_g51);
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;786.9666;550.4173;1;True;False
Node;AmplifyShaderEditor.FunctionNode;8;-805,-177.5;Inherit;False;SF_DistortTexture;26;;42;96c99f2862d31594fbaa887784570dd8;0;3;16;FLOAT;0;False;17;FLOAT;1;False;11;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-723,-17.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;10;-493,-55.5;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.VertexColorNode;12;-393.3,-418.6999;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;11;-222,133.5;Inherit;False;SF_EdgeFade;29;;41;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;7;-342,-110.5;Inherit;False;SF_PanningTexture;0;;44;b045855c7f4c7344eb8723194efc0969;0;7;3;SAMPLER2D;;False;46;FLOAT;0;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-33,174.5;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;17;508,-108.5;Inherit;False;SF_DepthFade;10;;52;adc458ead34511148bae829420de626c;0;1;6;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;16;275,15.5;Inherit;False;SF_AlphaSharp;22;;51;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-67.01587,-364.2377;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;19;244.9841,-242.0377;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;15;199,155.5;Inherit;False;SF_AlphaLerp;20;;50;853a1742ead4a334f9e5c5176cca2294;0;2;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-245.1159,-489.0378;Inherit;False;Property;_VertexColorStrength;VertexColorStrength;13;0;Create;True;0;0;0;False;0;False;3;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;14;-17,-205.5;Inherit;False;SF_Bicolor;14;;49;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;22;133.0334,-70.4173;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;753,-15.5;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=721BB07B5AFF9A8747B8AFCAD75FBEECA63215B4