	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float smoothstepResult4_g39 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g39.x ));
				float smoothstepResult5_g39 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g39.y);
				float smoothstepResult6_g39 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g39.y ));
				float lerpResult14_g39 = lerp( 1.0 , ( smoothstepResult3_g39 * smoothstepResult4_g39 * smoothstepResult5_g39 * smoothstepResult6_g39 ) , _EdgeFade_Enable);
...
Node;AmplifyShaderEditor.AbsOpNode;24;-266.2107,592.542;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-1166.873,221.7377;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
