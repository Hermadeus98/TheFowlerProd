	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexPos1_g17 = inputMesh.positionOS;
				float4 ase_clipPos1_g17 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g17));
				float4 screenPos1_g17 = ComputeScreenPos( ase_clipPos1_g17 , _ProjectionParams.x );
				o.ase_texcoord2 = screenPos1_g17;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord28_g15 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g15 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g15 = appendResult48_g15;
				float4 texCoord11 = packedInput.ase_texcoord1;
				texCoord11.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_31_0_g15 = ( texCoord11.z + _Soulercoaster_DebugPan );
				float2 appendResult38_g15 = (float2(temp_output_31_0_g15 , 0.0));
				float2 appendResult39_g15 = (float2(0.0 , temp_output_31_0_g15));
				float2 lerpResult40_g15 = lerp( appendResult38_g15 , appendResult39_g15 , _Soulercoaster_InvertPanUV);
				float2 temp_output_42_0_g15 = ( ( ( _PanningAlphaTex_ST.xy * ( texCoord28_g15 - temp_output_25_0_g15 ) ) + temp_output_25_0_g15 ) + lerpResult40_g15 );
				float2 lerpResult43_g15 = lerp( temp_output_42_0_g15 , (temp_output_42_0_g15).yx , _Soulercoaster_InvertUV);
				float4 tex2DNode1_g15 = tex2D( _PanningAlphaTex, lerpResult43_g15 );
				float temp_output_23_0 = tex2DNode1_g15.r;
				float smoothstepResult5_g18 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , temp_output_23_0);
				float lerpResult12_g18 = lerp( smoothstepResult5_g18 , ( 1.0 - smoothstepResult5_g18 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g18 = lerp( _ColorA , _ColorB , lerpResult12_g18);
				float temp_output_7_0_g19 = ( _AlphaThreshold + 0.0 );
				float2 texCoord9 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_1_0_g19 = texCoord9.x;
				float lerpResult9_g19 = lerp( temp_output_1_0_g19 , ( 1.0 - temp_output_1_0_g19 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g19 = smoothstep( temp_output_7_0_g19 , ( temp_output_7_0_g19 + _AlphaSmoothness ) , lerpResult9_g19);
				float temp_output_30_0 = smoothstepResult2_g19;
				
				float2 texCoord7_g16 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g16 = frac( texCoord7_g16 );
				float smoothstepResult3_g16 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g16.x);
				float smoothstepResult4_g16 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g16.x ));
				float smoothstepResult5_g16 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g16.y);
				float smoothstepResult6_g16 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g16.y ));
				float lerpResult14_g16 = lerp( 1.0 , ( smoothstepResult3_g16 * smoothstepResult4_g16 * smoothstepResult5_g16 * smoothstepResult6_g16 ) , _EdgeFade_Enable);
				float4 screenPos1_g17 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm1 = screenPos1_g17 / screenPos1_g17.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g17 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g17 = saturate( abs( ( screenDepth1_g17 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g17 = lerp( distanceDepth1_g17 , ( 1.0 - distanceDepth1_g17 ) , _DF_OneMinus);
				float3 ase_worldNormal = packedInput.ase_texcoord3.xyz;
				float dotResult16 = dot( V , ase_worldNormal );
				float temp_output_19_0 = abs( dotResult16 );
				float smoothstepResult32 = smoothstep( 0.0 , 0.5 , saturate( temp_output_19_0 ));
				
				surfaceDescription.Color = ( lerpResult4_g18 + ( _Emissive * temp_output_30_0 ) ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( temp_output_23_0 * lerpResult14_g16 * lerpResult3_g17 * smoothstepResult32 * packedInput.ase_color.a * _Alpha ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float4 ase_clipPos1_g17 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g17));
				float4 screenPos1_g17 = ComputeScreenPos( ase_clipPos1_g17 , _ProjectionParams.x );
				o.ase_texcoord1 = screenPos1_g17;
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord28_g15 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g15 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g15 = appendResult48_g15;
				float4 texCoord11 = packedInput.ase_texcoord;
				texCoord11.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_31_0_g15 = ( texCoord11.z + _Soulercoaster_DebugPan );
				float2 appendResult38_g15 = (float2(temp_output_31_0_g15 , 0.0));
				float2 appendResult39_g15 = (float2(0.0 , temp_output_31_0_g15));
				float2 lerpResult40_g15 = lerp( appendResult38_g15 , appendResult39_g15 , _Soulercoaster_InvertPanUV);
				...
				float4 tex2DNode1_g15 = tex2D( _PanningAlphaTex, lerpResult43_g15 );
				float temp_output_23_0 = tex2DNode1_g15.r;
				float2 texCoord7_g16 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g16 = frac( texCoord7_g16 );
				float smoothstepResult3_g16 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g16.x);
				float smoothstepResult4_g16 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g16.x ));
				float smoothstepResult5_g16 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g16.y);
				float smoothstepResult6_g16 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g16.y ));
				float lerpResult14_g16 = lerp( 1.0 , ( smoothstepResult3_g16 * smoothstepResult4_g16 * smoothstepResult5_g16 * smoothstepResult6_g16 ) , _EdgeFade_Enable);
				float4 screenPos1_g17 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm1 = screenPos1_g17 / screenPos1_g17.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g17 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g17 = saturate( abs( ( screenDepth1_g17 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				float4 ase_clipPos1_g17 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g17));
				float4 screenPos1_g17 = ComputeScreenPos( ase_clipPos1_g17 , _ProjectionParams.x );
				o.ase_texcoord4 = screenPos1_g17;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord28_g15 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult48_g15 = (float2(_Soulercoaster_Center.x , _Soulercoaster_Center.y));
				float2 temp_output_25_0_g15 = appendResult48_g15;
				float4 texCoord11 = packedInput.ase_texcoord3;
				texCoord11.xy = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_31_0_g15 = ( texCoord11.z + _Soulercoaster_DebugPan );
				float2 appendResult38_g15 = (float2(temp_output_31_0_g15 , 0.0));
				float2 appendResult39_g15 = (float2(0.0 , temp_output_31_0_g15));
				float2 lerpResult40_g15 = lerp( appendResult38_g15 , appendResult39_g15 , _Soulercoaster_InvertPanUV);
				...
				float4 tex2DNode1_g15 = tex2D( _PanningAlphaTex, lerpResult43_g15 );
				float temp_output_23_0 = tex2DNode1_g15.r;
				float2 texCoord7_g16 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g16 = frac( texCoord7_g16 );
				float smoothstepResult3_g16 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g16.x);
				float smoothstepResult4_g16 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g16.x ));
				float smoothstepResult5_g16 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g16.y);
				float smoothstepResult6_g16 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g16.y ));
				float lerpResult14_g16 = lerp( 1.0 , ( smoothstepResult3_g16 * smoothstepResult4_g16 * smoothstepResult5_g16 * smoothstepResult6_g16 ) , _EdgeFade_Enable);
				float4 screenPos1_g17 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm1 = screenPos1_g17 / screenPos1_g17.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g17 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g17 = saturate( abs( ( screenDepth1_g17 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
...
/*ASEBEGIN
Version=18900
1913;237;1920;1013;943.1261;235.1762;1.128896;True;False
Node;AmplifyShaderEditor.WorldNormalVector;18;-960.0453,556.6025;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;17;-968.9637,367.8307;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;16;-720.736,443.6367;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;19;-521.5594,434.7183;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-683.7581,157.5402;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;21;-291.8462,456.9949;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;15;-351.1688,624.2063;Inherit;False;SF_DepthFade;13;;17;adc458ead34511148bae829420de626c;0;1;6;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;31;-85.48817,773.4214;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;12;-297.7581,314.5402;Inherit;False;SF_EdgeFade;16;;16;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;23;-385.7582,168.5402;Inherit;False;SF_SoulercoasterAlpha;0;;15;17e687cf74ec1c14fba2843a0e8105d3;0;3;25;FLOAT2;0,0;False;27;FLOAT2;0,0;False;30;FLOAT;0;False;2;FLOAT;0;FLOAT;49
Node;AmplifyShaderEditor.SmoothstepOpNode;32;-150.9639,457.3306;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;128.1962,558.4377;Inherit;False;Property;_Alpha;Alpha;10;0;Create;True;0;0;0;False;0;False;1;8.57;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;195.0523,291.0203;Inherit;False;6;6;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;29;-71.94142,-244.8429;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-539.3969,584.8438;Inherit;False;Property;_FresnelPower;FresnelPower;12;0;Create;True;0;0;0;False;0;False;8;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;20;-429.403,442.1503;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;30;-338.3608,-155.6602;Inherit;False;SF_AlphaSharp;6;;19;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;26;-432.0587,-10.03248;Inherit;False;Property;_Emissive;Emissive;11;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-59.52307,118.6617;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;10;32.37652,-59.23322;Inherit;False;SF_Bicolor;21;;18;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;9;-626.2298,-261.9544;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;34;348.3309,355.2364;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;202.3803,-225.6516;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;27;434.9335,-28.09481;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;13;5;33;0
WireConnection;29;0;30;0
WireConnection;20;0;19;0
WireConnection;20;1;22;0
WireConnection;30;1;9;1
WireConnection;24;0;26;0
WireConnection;24;1;23;49
...
ASEEND*/
//CHKSM=C021B52920FBCE227105932897C1FC016A432844