	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 temp_output_1_0_g12 = _PanningTex_ST.zw;
				float2 break3_g12 = temp_output_1_0_g12;
				float4 appendResult5_g12 = (float4(break3_g12.y , break3_g12.x , 0.0 , 0.0));
				float4 lerpResult2_g12 = lerp( float4( temp_output_1_0_g12, 0.0 , 0.0 ) , appendResult5_g12 , _PanningTex_InvertUV);
				float4 screenPos = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 temp_output_1_0_g11 = ase_screenPosNorm.xy;
				...
				float2 temp_output_1_0_g9 = ( _PanningTex_ST.xy * float2( 1,1 ) );
				float2 break3_g9 = temp_output_1_0_g9;
				float4 appendResult5_g9 = (float4(break3_g9.y , break3_g9.x , 0.0 , 0.0));
				float4 lerpResult2_g9 = lerp( float4( temp_output_1_0_g9, 0.0 , 0.0 ) , appendResult5_g9 , _PanningTex_InvertUV);
				float2 panner1_g10 = ( 1.0 * _Time.y * (lerpResult2_g12).xy + ( (lerpResult2_g11).xy * (lerpResult2_g9).xy ));
				float2 texCoord9_g1 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode2_g1 = tex2D( _PanningTex, ( float2( 0,0 ) + panner1_g10 ), ddx( texCoord9_g1 ), ddy( texCoord9_g1 ) );
				
				float temp_output_7_0_g18 = ( _AlphaThreshold + 0.0 );
				float lerpResult38_g1 = lerp( tex2DNode2_g1.r , ( 1.0 - tex2DNode2_g1.r ) , _PanningTex_AlphaOneMinus);
				float2 texCoord7_g15 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g15 = frac( texCoord7_g15 );
				float smoothstepResult3_g15 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g15.x);
				float smoothstepResult4_g15 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g15.x ));
				float smoothstepResult5_g15 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g15.y);
				float smoothstepResult6_g15 = smoothstep( _EdgeFadeV.z , _EdgeFadeV.w , ( 1.0 - break9_g15.y ));
				float lerpResult14_g15 = lerp( 1.0 , ( smoothstepResult3_g15 * smoothstepResult4_g15 * smoothstepResult5_g15 * smoothstepResult6_g15 ) , _EdgeFade_Enable);
				float temp_output_1_0_g18 = ( ( lerpResult38_g1 * _PanningTex_AlphaStrength ) - lerpResult14_g15 );
				float lerpResult9_g18 = lerp( temp_output_1_0_g18 , ( 1.0 - temp_output_1_0_g18 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g18 = smoothstep( temp_output_7_0_g18 , ( temp_output_7_0_g18 + _AlphaSmoothness ) , lerpResult9_g18);
				float screenDepth1_g17 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth1_g17 = saturate( abs( ( screenDepth1_g17 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g17 = lerp( distanceDepth1_g17 , ( 1.0 - distanceDepth1_g17 ) , _DF_OneMinus);
				
				surfaceDescription.Color = ( _Color * tex2DNode2_g1 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( smoothstepResult2_g18 * lerpResult3_g17 );
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode2_g1 = tex2D( _PanningTex, ( float2( 0,0 ) + panner1_g10 ), ddx( texCoord9_g1 ), ddy( texCoord9_g1 ) );
				float lerpResult38_g1 = lerp( tex2DNode2_g1.r , ( 1.0 - tex2DNode2_g1.r ) , _PanningTex_AlphaOneMinus);
				float2 texCoord7_g15 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g15 = frac( texCoord7_g15 );
				float smoothstepResult3_g15 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g15.x);
				float smoothstepResult4_g15 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g15.x ));
				float smoothstepResult5_g15 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g15.y);
		...
		Pass
		{
					...
					)
			{
				...
				float4 lerpResult2_g9 = lerp( float4( temp_output_1_0_g9, 0.0 , 0.0 ) , appendResult5_g9 , _PanningTex_InvertUV);
				float2 panner1_g10 = ( 1.0 * _Time.y * (lerpResult2_g12).xy + ( (lerpResult2_g11).xy * (lerpResult2_g9).xy ));
				float2 texCoord9_g1 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode2_g1 = tex2D( _PanningTex, ( float2( 0,0 ) + panner1_g10 ), ddx( texCoord9_g1 ), ddy( texCoord9_g1 ) );
				float lerpResult38_g1 = lerp( tex2DNode2_g1.r , ( 1.0 - tex2DNode2_g1.r ) , _PanningTex_AlphaOneMinus);
				float2 texCoord7_g15 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g15 = frac( texCoord7_g15 );
				float smoothstepResult3_g15 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g15.x);
				float smoothstepResult4_g15 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g15.x ));
				float smoothstepResult5_g15 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g15.y);
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;1183;609.5;1;True;False
Node;AmplifyShaderEditor.ScreenPosInputsNode;18;-578,-226.5;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;7;-380,-53.5;Inherit;False;SF_PanningTexture;0;;1;b045855c7f4c7344eb8723194efc0969;0;6;3;SAMPLER2D;;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;2;COLOR;0;FLOAT;22
Node;AmplifyShaderEditor.FunctionNode;10;-71,187.5;Inherit;False;SF_EdgeFade;5;;15;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;11;123,65.5;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;13;580,230.5;Inherit;False;SF_DepthFade;13;;17;adc458ead34511148bae829420de626c;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;12;383,85.5;Inherit;False;SF_AlphaSharp;9;;18;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;16;27,-252.5;Inherit;False;Property;_Color;Color;16;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;368,-173.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;763,158.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1076,49;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;13;S_ScreenSpaceVFX;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;0;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=C091300549A99F06DF738BBAC1EC05C4F173248E