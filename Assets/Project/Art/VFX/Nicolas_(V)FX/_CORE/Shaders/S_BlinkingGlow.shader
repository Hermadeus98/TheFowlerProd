...
Shader "S_BlinkingGlow"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Glow("Glow", 2D) = "white" {}
		[Header(DepthFade)]_DF_Distance("DF_Distance", Float) = 0.5
		[Toggle]_DF_OneMinus("DF_OneMinus", Float) = 0
		[Header(Flicker)]_Flicker_StrengthMin("Flicker_StrengthMin", Float) = 1
		_Flicker_StrengthMax("Flicker_StrengthMax", Float) = 1
		_Flicker_Speed("Flicker_Speed", Float) = 1
		_Flicker_ManualProgress("Flicker_ManualProgress", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Glow_ST;
			float4 _Color;
			float _Flicker_StrengthMin;
			float _Flicker_StrengthMax;
			float _Flicker_ManualProgress;
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexPos1_g2 = inputMesh.positionOS;
				float4 ase_clipPos1_g2 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g2));
				float4 screenPos1_g2 = ComputeScreenPos( ase_clipPos1_g2 , _ProjectionParams.x );
				o.ase_texcoord2 = screenPos1_g2;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_Glow = packedInput.ase_texcoord1.xy * _Glow_ST.xy + _Glow_ST.zw;
				float4 tex2DNode7 = tex2D( _Glow, uv_Glow );
				float mulTime2_g4 = _TimeParameters.x * _Flicker_Speed;
				float lerpResult10_g4 = lerp( ( _Flicker_StrengthMin + 0.0 ) , ( _Flicker_StrengthMax + 0.0 ) , ( ( sin( ( _Flicker_ManualProgress + mulTime2_g4 ) ) + 1.0 ) / 2.0 ));
				
				float4 screenPos1_g2 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm1 = screenPos1_g2 / screenPos1_g2.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g2 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g2 = saturate( abs( ( screenDepth1_g2 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g2 = lerp( distanceDepth1_g2 , ( 1.0 - distanceDepth1_g2 ) , _DF_OneMinus);
				float eyeDepth = packedInput.ase_texcoord1.z;
				float cameraDepthFade15 = (( eyeDepth -_ProjectionParams.y - 0.0 ) / _CamDepthFade);
				
				surfaceDescription.Color = ( tex2DNode7 * _Color * packedInput.ase_color * lerpResult10_g4 ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( tex2DNode7.a * packedInput.ase_color.a * lerpResult3_g2 * saturate( cameraDepthFade15 ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Glow = packedInput.ase_texcoord.xy * _Glow_ST.xy + _Glow_ST.zw;
				float4 tex2DNode7 = tex2D( _Glow, uv_Glow );
				float4 screenPos1_g2 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm1 = screenPos1_g2 / screenPos1_g2.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g2 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g2 = saturate( abs( ( screenDepth1_g2 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Glow = packedInput.ase_texcoord3.xy * _Glow_ST.xy + _Glow_ST.zw;
				float4 tex2DNode7 = tex2D( _Glow, uv_Glow );
				float4 screenPos1_g2 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm1 = screenPos1_g2 / screenPos1_g2.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g2 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g2 = saturate( abs( ( screenDepth1_g2 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
...
/*ASEBEGIN
Version=18900
-1920;18;1920;1001;1053.903;414.641;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;17;-647.903,369.359;Inherit;False;Property;_CamDepthFade;CamDepthFade;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CameraDepthFade;15;-397.903,356.359;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;13;-392.5861,231.5256;Inherit;False;SF_DepthFade;1;;2;adc458ead34511148bae829420de626c;0;1;6;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;18;-93.90295,355.359;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-752.5863,-43.47437;Inherit;True;Property;_Glow;Glow;0;0;Create;True;0;0;0;False;0;False;-1;67393c241b8367a4e9329f06552ad1df;67393c241b8367a4e9329f06552ad1df;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;10;-451.5863,47.52563;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;14;-273.5863,-307.4744;Inherit;False;SF_Flicker;4;;4;a841e51190649014d9b5c2e04cb7126b;0;2;12;FLOAT;0;False;16;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-33.5863,-66.47437;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;9;-534.5863,-220.4744;Inherit;False;Property;_Color;Color;10;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-153.5863,115.5256;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E49ACE0845F77C488EF1ABEC907E1EB9E76D1034