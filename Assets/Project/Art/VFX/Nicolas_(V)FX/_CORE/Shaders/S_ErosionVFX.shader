...
Shader "S_ErosionVFX"
{
	Properties
	{
		...
		[ASEEnd][Toggle(_USETEXTUREALPHA_ON)] _UseTextureAlpha("UseTextureAlpha", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexPos1_g43 = inputMesh.positionOS;
				float4 ase_clipPos1_g43 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g43));
				float4 screenPos1_g43 = ComputeScreenPos( ase_clipPos1_g43 , _ProjectionParams.x );
				o.ase_texcoord2 = screenPos1_g43;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 temp_cast_0 = (tex2DNode31.r).xxxx;
				float4 appendResult43_g17 = (float4(0.0 , _PanningTex_ManualOffset , 0.0 , 0.0));
				float4 appendResult42_g17 = (float4(_PanningTex_ManualOffset , 0.0 , 0.0 , 0.0));
				float4 lerpResult41_g17 = lerp( appendResult43_g17 , appendResult42_g17 , _PanningTex_InvertUV);
				...
				float2 texCoord9_g17 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g37 = texCoord9_g17;
				...
				float4 temp_output_45_0 = tex2D( _PanningTex, ( ( float4( float2( 0,0 ), 0.0 , 0.0 ) + lerpResult41_g17 ).xy + panner1_g35 ), ddx( texCoord9_g17 ), ddy( texCoord9_g17 ) );
				float4 lerpResult59 = lerp( temp_cast_0 , temp_output_45_0 , _ColorTex);
				float smoothstepResult5_g42 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , lerpResult59.r);
				float lerpResult12_g42 = lerp( smoothstepResult5_g42 , ( 1.0 - smoothstepResult5_g42 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g42 = lerp( _ColorA , _ColorB , lerpResult12_g42);
				float4 texCoord1_g39 = packedInput.ase_texcoord1;
				texCoord1_g39.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult9_g39 = lerp( 1.0 , ( texCoord1_g39.w + 1.0 ) , _EnableCustomData);
				...
				#endif
				float4 screenPos1_g43 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm1 = screenPos1_g43 / screenPos1_g43.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g43 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g43 = saturate( abs( ( screenDepth1_g43 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g43 = lerp( distanceDepth1_g43 , ( 1.0 - distanceDepth1_g43 ) , _DF_OneMinus);
				float lerpResult10_g39 = lerp( 0.0 , texCoord1_g39.z , _EnableCustomData);
				float temp_output_7_0_g41 = ( _AlphaThreshold + lerpResult10_g39 );
				float2 texCoord7_g40 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g40 = frac( texCoord7_g40 );
				float smoothstepResult3_g40 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g40.x);
				float smoothstepResult4_g40 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g40.x ));
				float smoothstepResult5_g40 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g40.y);
				float smoothstepResult6_g40 = smoothstep( _EdgeFadeV.z , ( _EdgeFadeV.w + _AddedEdgeFade ) , ( 1.0 - break9_g40.y ));
				float lerpResult14_g40 = lerp( 1.0 , ( smoothstepResult3_g40 * smoothstepResult4_g40 * smoothstepResult5_g40 * smoothstepResult6_g40 ) , _EdgeFade_Enable);
				float temp_output_55_0 = lerpResult14_g40;
				float lerpResult1_g44 = lerp( temp_output_55_0 , temp_output_45_0.r , _AlphaLerp_TexInfluence);
				float temp_output_1_0_g41 = lerpResult1_g44;
				float lerpResult9_g41 = lerp( temp_output_1_0_g41 , ( 1.0 - temp_output_1_0_g41 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g41 = smoothstep( temp_output_7_0_g41 , ( temp_output_7_0_g41 + _AlphaSmoothness ) , lerpResult9_g41);
				
				surfaceDescription.Color = ( lerpResult4_g42 * packedInput.ase_color * ( lerpResult9_g39 + 1.0 ) ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( staticSwitch39 * packedInput.ase_color.a * lerpResult3_g43 * smoothstepResult2_g41 * _AlphaMul * temp_output_55_0 ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float4 ase_clipPos1_g43 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g43));
				float4 screenPos1_g43 = ComputeScreenPos( ase_clipPos1_g43 , _ProjectionParams.x );
				o.ase_texcoord1 = screenPos1_g43;
					...
					)
			{
				...
				float staticSwitch39 = tex2DNode31.r;
				#endif
				float4 screenPos1_g43 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm1 = screenPos1_g43 / screenPos1_g43.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g43 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g43 = saturate( abs( ( screenDepth1_g43 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g43 = lerp( distanceDepth1_g43 , ( 1.0 - distanceDepth1_g43 ) , _DF_OneMinus);
				float4 texCoord1_g39 = packedInput.ase_texcoord;
				texCoord1_g39.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult10_g39 = lerp( 0.0 , texCoord1_g39.z , _EnableCustomData);
				float temp_output_7_0_g41 = ( _AlphaThreshold + lerpResult10_g39 );
				float2 texCoord7_g40 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g40 = frac( texCoord7_g40 );
				float smoothstepResult3_g40 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g40.x);
				float smoothstepResult4_g40 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g40.x ));
				float smoothstepResult5_g40 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g40.y);
				...
				float4 appendResult5_g36 = (float4(break3_g36.y , break3_g36.x , 0.0 , 0.0));
				float4 lerpResult2_g36 = lerp( float4( temp_output_1_0_g36, 0.0 , 0.0 ) , appendResult5_g36 , _PanningTex_InvertUV);
				float2 texCoord9_g17 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g37 = texCoord9_g17;
				float2 break3_g37 = temp_output_1_0_g37;
				float4 appendResult5_g37 = (float4(break3_g37.y , break3_g37.x , 0.0 , 0.0));
				float4 lerpResult2_g37 = lerp( float4( temp_output_1_0_g37, 0.0 , 0.0 ) , appendResult5_g37 , _PanningTex_InvertUV);
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				float4 ase_clipPos1_g43 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g43));
				float4 screenPos1_g43 = ComputeScreenPos( ase_clipPos1_g43 , _ProjectionParams.x );
				o.ase_texcoord4 = screenPos1_g43;
					...
					)
			{
				...
				float staticSwitch39 = tex2DNode31.r;
				#endif
				float4 screenPos1_g43 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm1 = screenPos1_g43 / screenPos1_g43.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g43 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g43 = saturate( abs( ( screenDepth1_g43 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g43 = lerp( distanceDepth1_g43 , ( 1.0 - distanceDepth1_g43 ) , _DF_OneMinus);
				float4 texCoord1_g39 = packedInput.ase_texcoord3;
				texCoord1_g39.xy = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult10_g39 = lerp( 0.0 , texCoord1_g39.z , _EnableCustomData);
				float temp_output_7_0_g41 = ( _AlphaThreshold + lerpResult10_g39 );
				float2 texCoord7_g40 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g40 = frac( texCoord7_g40 );
				float smoothstepResult3_g40 = smoothstep( _EdgeFadeU.x , ( _AddedEdgeFade + _EdgeFadeU.y ) , break9_g40.x);
				float smoothstepResult4_g40 = smoothstep( _EdgeFadeU.z , ( _EdgeFadeU.w + _AddedEdgeFade ) , ( 1.0 - break9_g40.x ));
				float smoothstepResult5_g40 = smoothstep( _EdgeFadeV.x , ( _EdgeFadeV.y + _AddedEdgeFade ) , break9_g40.y);
				...
				float4 appendResult5_g36 = (float4(break3_g36.y , break3_g36.x , 0.0 , 0.0));
				float4 lerpResult2_g36 = lerp( float4( temp_output_1_0_g36, 0.0 , 0.0 ) , appendResult5_g36 , _PanningTex_InvertUV);
				float2 texCoord9_g17 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g37 = texCoord9_g17;
				float2 break3_g37 = temp_output_1_0_g37;
				float4 appendResult5_g37 = (float4(break3_g37.y , break3_g37.x , 0.0 , 0.0));
				float4 lerpResult2_g37 = lerp( float4( temp_output_1_0_g37, 0.0 , 0.0 ) , appendResult5_g37 , _PanningTex_InvertUV);
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;1255.987;379.6372;1.294718;True;False
Node;AmplifyShaderEditor.FunctionNode;55;-302.8193,504.1461;Inherit;False;SF_EdgeFade;6;;40;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;45;-330.6314,285.1489;Inherit;False;SF_PanningTexture;14;;17;b045855c7f4c7344eb8723194efc0969;0;7;3;SAMPLER2D;;False;46;FLOAT;0;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;23;-797.6082,-204.1021;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;852f47eb1c077914eaf89c8f38402713;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;54;-41.32896,602.6448;Inherit;False;SF_PanningCustomData;11;;39;1838fadec439af641a6efc75ce73938c;0;0;4;FLOAT;0;FLOAT;3;FLOAT4;5;FLOAT4;6
Node;AmplifyShaderEditor.FunctionNode;58;-23.41516,419.2039;Inherit;False;SF_AlphaLerp;4;;44;853a1742ead4a334f9e5c5176cca2294;0;2;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;31;-514.9302,-106.5219;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;39;115.9766,164.6231;Inherit;False;Property;_UseTextureAlpha;UseTextureAlpha;36;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;41;141.9767,-273.577;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;48;400.4687,444.3491;Inherit;False;SF_AlphaSharp;26;;41;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;767.2552,597.5717;Inherit;False;Property;_AlphaMul;AlphaMul;25;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;56;138.391,316.5906;Inherit;False;SF_DepthFade;1;;43;adc458ead34511148bae829420de626c;0;1;6;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;817.8766,228.223;Inherit;False;6;6;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;51;356.4552,646.9719;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;38;175.9767,-66.57703;Inherit;False;SF_Bicolor;30;;42;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;52;964.8552,211.4717;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;59;-55.78295,-87.03083;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;60;-187.8443,13.95718;Inherit;False;Property;_ColorTex;ColorTex;24;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DepthFade;43;-25.32336,219.8232;Inherit;False;True;True;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;486.9767,-26.57703;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;12;1089.1,22.7;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;13;S_ErosionVFX;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Transparent=Queue=-250;True;5;0;False;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-25;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;1;  Rendering Pass ;0;  Rendering Pass;0;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;1;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
...
WireConnection;12;2;52;0
ASEEND*/
//CHKSM=1D362DABA4EE4570976B27D8D67C4D5848321A80