...
Shader "S_PanningVFX"
{
	Properties
	{
		...
		[ASEBegin][Toggle][Header(CustomData)]_EnableCustomData("EnableCustomData", Float) = 1
		[Toggle]_CustomData_OffsetInvertUV("CustomData_OffsetInvertUV", Float) = 0
		[Header(Panning Texture)]_PanningTex("PanningTex", 2D) = "white" {}
		[Toggle]_PanningTex_AlphaOneMinus("PanningTex_AlphaOneMinus", Float) = 0
		_PanningTex_AlphaStrength("PanningTex_AlphaStrength", Float) = 0.5
		...
		_CamDepthFade("CamDepthFade", Float) = 0
		[Toggle]_VertexAlphaIsSharpened("VertexAlphaIsSharpened", Float) = 0
		...
		[HDR]_ColorMul("ColorMul", Color) = (1,1,1,1)
		[Toggle(_NOBICOLOR_ON)] _NoBicolor("NoBicolor", Float) = 0
		...
		[Toggle]_UseUVGradient("UseUVGradient", Float) = 0
		[ASEEnd]_UVGradient("UVGradient", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _NOBICOLOR_ON
			...
			float _VertexAlphaIsSharpened;
			float _EnableCustomData;
			float _PanningTex_AlphaOneMinus;
			float _PanningTex_AlphaStrength;
			...
			float _CustomData_OffsetInvertUV;
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexPos1_g66 = inputMesh.positionOS;
				float4 ase_clipPos1_g66 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g66));
				float4 screenPos1_g66 = ComputeScreenPos( ase_clipPos1_g66 , _ProjectionParams.x );
				o.ase_texcoord4 = screenPos1_g66;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 texCoord1_g44 = packedInput.ase_texcoord1;
				texCoord1_g44.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult9_g44 = lerp( 1.0 , ( texCoord1_g44.w + 1.0 ) , _EnableCustomData);
				float2 texCoord2_g44 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g44 = lerp( 0.0 , texCoord2_g44.x , _EnableCustomData);
				float4 appendResult15_g44 = (float4(lerpResult11_g44 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g44 = (float4(0.0 , lerpResult11_g44 , 0.0 , 0.0));
				float4 lerpResult17_g44 = lerp( appendResult15_g44 , appendResult16_g44 , _CustomData_OffsetInvertUV);
				float4 appendResult43_g59 = (float4(0.0 , _PanningTex_ManualOffset , 0.0 , 0.0));
				float4 appendResult42_g59 = (float4(_PanningTex_ManualOffset , 0.0 , 0.0 , 0.0));
				float4 lerpResult41_g59 = lerp( appendResult43_g59 , appendResult42_g59 , _PanningTex_InvertUV);
				float2 temp_output_1_0_g60 = _PanningTex_ST.zw;
				...
				float2 texCoord9_g59 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g61 = texCoord9_g59;
				...
				float lerpResult8_g44 = lerp( 1.0 , texCoord2_g44.y , _EnableCustomData);
				float4 appendResult20_g44 = (float4(lerpResult8_g44 , 1.0 , 0.0 , 0.0));
				float4 appendResult19_g44 = (float4(1.0 , lerpResult8_g44 , 0.0 , 0.0));
				float4 lerpResult18_g44 = lerp( appendResult20_g44 , appendResult19_g44 , _CustomData_OffsetInvertUV);
				float2 temp_output_1_0_g62 = ( _PanningTex_ST.xy * lerpResult18_g44.xy );
				...
				float2 panner1_g63 = ( 1.0 * _Time.y * (lerpResult2_g60).xy + ( (lerpResult2_g61).xy * (lerpResult2_g62).xy ));
				float4 tex2DNode2_g59 = tex2D( _PanningTex, ( ( float4( lerpResult17_g44.xy, 0.0 , 0.0 ) + lerpResult41_g59 ).xy + panner1_g63 ), ddx( texCoord9_g59 ), ddy( texCoord9_g59 ) );
				float4 temp_output_63_0 = tex2DNode2_g59;
				float2 texCoord54 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult57 = lerp( temp_output_63_0 , ( ( texCoord54.y + temp_output_63_0 ) * _UVGradient ) , _UseUVGradient);
				float smoothstepResult5_g68 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , lerpResult57.r);
				float lerpResult12_g68 = lerp( smoothstepResult5_g68 , ( 1.0 - smoothstepResult5_g68 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g68 = lerp( _ColorA , _ColorB , lerpResult12_g68);
				#ifdef _NOBICOLOR_ON
				float4 staticSwitch26 = temp_output_63_0;
				#else
				float4 staticSwitch26 = lerpResult4_g68;
				#endif
				
				float lerpResult10_g44 = lerp( 0.0 , texCoord1_g44.z , _EnableCustomData);
				float temp_output_7_0_g67 = ( _AlphaThreshold + lerpResult10_g44 );
				float3 ase_worldNormal = packedInput.ase_texcoord3.xyz;
				float clampResult11_g43 = clamp( _FresnelPower , 0.0 , 50.0 );
				float fresnelNdotV1_g43 = dot( ase_worldNormal, V );
				float fresnelNode1_g43 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV1_g43, clampResult11_g43 ) );
				float smoothstepResult4_g43 = smoothstep( _FresnelThreshold , ( _FresnelThreshold + _FresnelSmoothess ) , fresnelNode1_g43);
				float lerpResult9_g43 = lerp( 1.0 , smoothstepResult4_g43 , _Fresnel_Enable);
				float2 texCoord7_g34 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g34 = frac( texCoord7_g34 );
				float smoothstepResult3_g34 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g34.x);
				float smoothstepResult4_g34 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g34.x ));
				float smoothstepResult5_g34 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g34.y);
				float smoothstepResult6_g34 = smoothstep( _EdgeFadeV.z , _EdgeFadeV.w , ( 1.0 - break9_g34.y ));
				float lerpResult14_g34 = lerp( 1.0 , ( smoothstepResult3_g34 * smoothstepResult4_g34 * smoothstepResult5_g34 * smoothstepResult6_g34 ) , _EdgeFade_Enable);
				float lerpResult65 = lerp( 1.0 , packedInput.ase_color.a , _VertexAlphaIsSharpened);
				float lerpResult38_g59 = lerp( tex2DNode2_g59.r , ( 1.0 - tex2DNode2_g59.r ) , _PanningTex_AlphaOneMinus);
				float temp_output_1_0_g67 = ( ( lerpResult9_g43 * lerpResult14_g34 * lerpResult65 ) - ( lerpResult38_g59 * _PanningTex_AlphaStrength ) );
				float lerpResult9_g67 = lerp( temp_output_1_0_g67 , ( 1.0 - temp_output_1_0_g67 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g67 = smoothstep( temp_output_7_0_g67 , ( temp_output_7_0_g67 + _AlphaSmoothness ) , lerpResult9_g67);
				float4 screenPos1_g66 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm1 = screenPos1_g66 / screenPos1_g66.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g66 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g66 = saturate( abs( ( screenDepth1_g66 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g66 = lerp( distanceDepth1_g66 , ( 1.0 - distanceDepth1_g66 ) , _DF_OneMinus);
				float lerpResult66 = lerp( packedInput.ase_color.a , 1.0 , _VertexAlphaIsSharpened);
				float eyeDepth = packedInput.ase_texcoord2.z;
				float cameraDepthFade67 = (( eyeDepth -_ProjectionParams.y - 0.0 ) / _CamDepthFade);
				
				surfaceDescription.Color = ( lerpResult9_g44 * staticSwitch26 * packedInput.ase_color * _ColorMul ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( smoothstepResult2_g67 * lerpResult3_g66 * _AlphaMul * lerpResult66 * saturate( cameraDepthFade67 ) ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 texCoord1_g44 = packedInput.ase_texcoord;
				texCoord1_g44.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult10_g44 = lerp( 0.0 , texCoord1_g44.z , _EnableCustomData);
				float temp_output_7_0_g67 = ( _AlphaThreshold + lerpResult10_g44 );
				...
				float clampResult11_g43 = clamp( _FresnelPower , 0.0 , 50.0 );
				float fresnelNdotV1_g43 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode1_g43 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV1_g43, clampResult11_g43 ) );
				float smoothstepResult4_g43 = smoothstep( _FresnelThreshold , ( _FresnelThreshold + _FresnelSmoothess ) , fresnelNode1_g43);
				float lerpResult9_g43 = lerp( 1.0 , smoothstepResult4_g43 , _Fresnel_Enable);
				float2 texCoord7_g34 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g34 = frac( texCoord7_g34 );
				float smoothstepResult3_g34 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g34.x);
				float smoothstepResult4_g34 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g34.x ));
				float smoothstepResult5_g34 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g34.y);
				...
				float lerpResult14_g34 = lerp( 1.0 , ( smoothstepResult3_g34 * smoothstepResult4_g34 * smoothstepResult5_g34 * smoothstepResult6_g34 ) , _EdgeFade_Enable);
				float lerpResult65 = lerp( 1.0 , packedInput.ase_color.a , _VertexAlphaIsSharpened);
				float2 texCoord2_g44 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g44 = lerp( 0.0 , texCoord2_g44.x , _EnableCustomData);
				float4 appendResult15_g44 = (float4(lerpResult11_g44 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g44 = (float4(0.0 , lerpResult11_g44 , 0.0 , 0.0));
				float4 lerpResult17_g44 = lerp( appendResult15_g44 , appendResult16_g44 , _CustomData_OffsetInvertUV);
				...
				float4 appendResult5_g60 = (float4(break3_g60.y , break3_g60.x , 0.0 , 0.0));
				float4 lerpResult2_g60 = lerp( float4( temp_output_1_0_g60, 0.0 , 0.0 ) , appendResult5_g60 , _PanningTex_InvertUV);
				float2 texCoord9_g59 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g61 = texCoord9_g59;
				float2 break3_g61 = temp_output_1_0_g61;
				float4 appendResult5_g61 = (float4(break3_g61.y , break3_g61.x , 0.0 , 0.0));
				float4 lerpResult2_g61 = lerp( float4( temp_output_1_0_g61, 0.0 , 0.0 ) , appendResult5_g61 , _PanningTex_InvertUV);
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				texCoord1_g44.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult9_g44 = lerp( 1.0 , ( texCoord1_g44.w + 1.0 ) , _EnableCustomData);
				float2 texCoord2_g44 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g44 = lerp( 0.0 , texCoord2_g44.x , _EnableCustomData);
				float4 appendResult15_g44 = (float4(lerpResult11_g44 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g44 = (float4(0.0 , lerpResult11_g44 , 0.0 , 0.0));
				float4 lerpResult17_g44 = lerp( appendResult15_g44 , appendResult16_g44 , _CustomData_OffsetInvertUV);
				...
				float4 tex2DNode2_g59 = tex2D( _PanningTex, ( ( float4( lerpResult17_g44.xy, 0.0 , 0.0 ) + lerpResult41_g59 ).xy + panner1_g63 ), ddx( texCoord9_g59 ), ddy( texCoord9_g59 ) );
				float4 temp_output_63_0 = tex2DNode2_g59;
				float2 texCoord54 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult57 = lerp( temp_output_63_0 , ( ( texCoord54.y + temp_output_63_0 ) * _UVGradient ) , _UseUVGradient);
				float smoothstepResult5_g68 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , lerpResult57.r);
				float lerpResult12_g68 = lerp( smoothstepResult5_g68 , ( 1.0 - smoothstepResult5_g68 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g68 = lerp( _ColorA , _ColorB , lerpResult12_g68);
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				float4 ase_clipPos1_g66 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g66));
				float4 screenPos1_g66 = ComputeScreenPos( ase_clipPos1_g66 , _ProjectionParams.x );
				o.ase_texcoord6 = screenPos1_g66;
				float3 objectToViewPos = TransformWorldToView(TransformObjectToWorld(inputMesh.positionOS));
				float eyeDepth = -objectToViewPos.z;
				...
				o.ase_color = inputMesh.ase_color;
				o.ase_texcoord5.xy = inputMesh.ase_texcoord1.xy;
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 texCoord1_g44 = packedInput.ase_texcoord3;
				texCoord1_g44.xy = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult10_g44 = lerp( 0.0 , texCoord1_g44.z , _EnableCustomData);
				float temp_output_7_0_g67 = ( _AlphaThreshold + lerpResult10_g44 );
				...
				float smoothstepResult4_g43 = smoothstep( _FresnelThreshold , ( _FresnelThreshold + _FresnelSmoothess ) , fresnelNode1_g43);
				float lerpResult9_g43 = lerp( 1.0 , smoothstepResult4_g43 , _Fresnel_Enable);
				float2 texCoord7_g34 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g34 = frac( texCoord7_g34 );
				float smoothstepResult3_g34 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g34.x);
				float smoothstepResult4_g34 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g34.x ));
				float smoothstepResult5_g34 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g34.y);
				...
				float lerpResult14_g34 = lerp( 1.0 , ( smoothstepResult3_g34 * smoothstepResult4_g34 * smoothstepResult5_g34 * smoothstepResult6_g34 ) , _EdgeFade_Enable);
				float lerpResult65 = lerp( 1.0 , packedInput.ase_color.a , _VertexAlphaIsSharpened);
				float2 texCoord2_g44 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g44 = lerp( 0.0 , texCoord2_g44.x , _EnableCustomData);
				float4 appendResult15_g44 = (float4(lerpResult11_g44 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g44 = (float4(0.0 , lerpResult11_g44 , 0.0 , 0.0));
				float4 lerpResult17_g44 = lerp( appendResult15_g44 , appendResult16_g44 , _CustomData_OffsetInvertUV);
				...
				float4 appendResult5_g60 = (float4(break3_g60.y , break3_g60.x , 0.0 , 0.0));
				float4 lerpResult2_g60 = lerp( float4( temp_output_1_0_g60, 0.0 , 0.0 ) , appendResult5_g60 , _PanningTex_InvertUV);
				float2 texCoord9_g59 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g61 = texCoord9_g59;
				float2 break3_g61 = temp_output_1_0_g61;
				float4 appendResult5_g61 = (float4(break3_g61.y , break3_g61.x , 0.0 , 0.0));
				float4 lerpResult2_g61 = lerp( float4( temp_output_1_0_g61, 0.0 , 0.0 ) , appendResult5_g61 , _PanningTex_InvertUV);
				...
				float lerpResult9_g67 = lerp( temp_output_1_0_g67 , ( 1.0 - temp_output_1_0_g67 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g67 = smoothstep( temp_output_7_0_g67 , ( temp_output_7_0_g67 + _AlphaSmoothness ) , lerpResult9_g67);
				float4 screenPos1_g66 = packedInput.ase_texcoord6;
				float4 ase_screenPosNorm1 = screenPos1_g66 / screenPos1_g66.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g66 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g66 = saturate( abs( ( screenDepth1_g66 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
...
/*ASEBEGIN
Version=18900
-1920;18;1920;1001;1526.951;530.5892;1.3;True;True
Node;AmplifyShaderEditor.RangedFloatNode;64;-1097.952,205.2109;Inherit;False;Property;_VertexAlphaIsSharpened;VertexAlphaIsSharpened;20;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;23;-1118.03,-16.35171;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;8;-952.5576,341.368;Inherit;False;SF_EdgeFade;15;;34;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;52;-954.7777,428.0662;Inherit;False;SF_Fresnel;37;;43;328e81c82eef2f646b26eac37838dca5;0;1;12;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;19;-1642.178,-251.1076;Inherit;False;SF_PanningCustomData;0;;44;1838fadec439af641a6efc75ce73938c;0;0;4;FLOAT;0;FLOAT;3;FLOAT4;5;FLOAT4;6
Node;AmplifyShaderEditor.LerpOp;65;-818.4512,205.2108;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;63;-1174.274,-172.327;Inherit;False;SF_PanningTexture;3;;59;b045855c7f4c7344eb8723194efc0969;0;6;3;SAMPLER2D;;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;2;COLOR;0;FLOAT;22
Node;AmplifyShaderEditor.RangedFloatNode;69;-342.6508,545.8107;Inherit;False;Property;_CamDepthFade;CamDepthFade;19;0;Create;True;0;0;0;False;0;False;0;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-665.7027,239.1757;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;48;-527.557,114.2972;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CameraDepthFade;67;-102.1508,506.8107;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;68;108.4492,437.9107;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;10;-318.9888,19.22905;Inherit;False;SF_AlphaSharp;29;;67;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;66;-269.8514,249.4108;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;43;-272.6179,127.6598;Inherit;False;SF_DepthFade;33;;66;adc458ead34511148bae829420de626c;0;1;6;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-101.557,307.2972;Inherit;False;Property;_AlphaMul;AlphaMul;36;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;23.4875,149.8141;Inherit;False;5;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-1079.77,-609.9691;Inherit;False;Property;_UVGradient;UVGradient;44;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;59;184.788,-197.5698;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;53;-1074.77,-480.9691;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;58;-888.77,-298.9691;Inherit;False;Property;_UseUVGradient;UseUVGradient;43;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;41;-492.353,-292.5328;Inherit;False;SF_Bicolor;21;;68;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-4.513045,-211.082;Inherit;False;4;4;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;45;207.443,215.2972;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;26;-292.9208,-169.5045;Inherit;False;Property;_NoBicolor;NoBicolor;28;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;55;-873.77,-465.9691;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;46;-292.557,-388.7028;Inherit;False;Property;_ColorMul;ColorMul;27;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;54;-1353.77,-543.9691;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;57;-649.77,-306.9691;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=2111BBD5D681BEF86DCAF170388E010E582CD6FB