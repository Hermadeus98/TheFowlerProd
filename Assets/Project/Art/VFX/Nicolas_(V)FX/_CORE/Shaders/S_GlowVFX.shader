	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 screenPos1_g1 = packedInput.ase_texcoord3;
				float4 ase_screenPosNorm1 = screenPos1_g1 / screenPos1_g1.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g1 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g1 = saturate( abs( ( screenDepth1_g1 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;806.2919;409.7585;1;True;False
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;14;-47.29187,296.2415;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldToObjectTransfNode;17;358.7081,262.2415;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-10.29187,-82.75854;Inherit;False;Property;_Value;Value;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;154.7081,337.2415;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-35.29187,474.2415;Inherit;False;Property;_CameraOffset;CameraOffset;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E4925AB701246966348BC87B3CFF8733E5030429