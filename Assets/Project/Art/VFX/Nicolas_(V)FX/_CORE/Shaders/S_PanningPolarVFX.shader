...
Shader "PanningPolarVFX"
{
	Properties
	{
		...
		[Toggle]_Polar_InvertUV("Polar_InvertUV", Float) = 0
		_Polar_Distort_U("Polar_Distort_U", Float) = 0
		[Toggle][Header(CustomData)]_EnableCustomData("EnableCustomData", Float) = 1
		...
		[Toggle]_Bicolor_OneMinusCircle("Bicolor_OneMinusCircle", Float) = 0
		...
		[ASEEnd]_AlphaMul("AlphaMul", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Bicolor_OneMinusCircle;
			float _CircleMask_Noise;
			float _Polar_InvertUV;
			float _PanningTex_InvertUV;
			float _DF_OneMinus;
			float _CustomData_OffsetInvertUV;
			float _CircleMask_Invert;
			float _CircleMask_Smoothness;
			float _CircleMask_Radius;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 texCoord1_g97 = packedInput.ase_texcoord1;
				texCoord1_g97.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult9_g97 = lerp( 1.0 , ( texCoord1_g97.w + 1.0 ) , _EnableCustomData);
				float temp_output_3_0_g103 = _CircleMask_Radius;
				float2 texCoord2_g103 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult10_g103 = smoothstep( temp_output_3_0_g103 , ( temp_output_3_0_g103 + _CircleMask_Smoothness ) , distance( texCoord2_g103 , _CircleMask_Center ));
				float lerpResult15_g103 = lerp( ( 1.0 - smoothstepResult10_g103 ) , smoothstepResult10_g103 , _CircleMask_Invert);
				float2 texCoord2_g97 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g97 = lerp( 0.0 , texCoord2_g97.x , _EnableCustomData);
				float4 appendResult15_g97 = (float4(lerpResult11_g97 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g97 = (float4(0.0 , lerpResult11_g97 , 0.0 , 0.0));
				float4 lerpResult17_g97 = lerp( appendResult15_g97 , appendResult16_g97 , _CustomData_OffsetInvertUV);
				float2 temp_output_1_0_g102 = _PanningTex_ST.zw;
				float2 break3_g102 = temp_output_1_0_g102;
				float4 appendResult5_g102 = (float4(break3_g102.y , break3_g102.x , 0.0 , 0.0));
				float4 lerpResult2_g102 = lerp( float4( temp_output_1_0_g102, 0.0 , 0.0 ) , appendResult5_g102 , _PanningTex_InvertUV);
				float2 texCoord2_g90 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g90 = texCoord2_g90;
				float2 temp_output_18_0_g90 = float2( 0.5,0.5 );
				float temp_output_3_0_g90 = distance( temp_output_1_0_g90 , temp_output_18_0_g90 );
				float2 break6_g90 = ( temp_output_1_0_g90 + ( temp_output_18_0_g90 * float2( -1,-1 ) ) );
				float temp_output_28_0_g90 = ( ( ( ( atan2( break6_g90.x , break6_g90.y ) / PI ) + 1.0 ) / 2.0 ) + ( temp_output_3_0_g90 * _Polar_Distort_U ) );
				float4 appendResult4_g90 = (float4(temp_output_3_0_g90 , temp_output_28_0_g90 , 0.0 , 0.0));
				float4 appendResult24_g90 = (float4(temp_output_28_0_g90 , temp_output_3_0_g90 , 0.0 , 0.0));
				float4 lerpResult25_g90 = lerp( appendResult4_g90 , appendResult24_g90 , _Polar_InvertUV);
				float2 temp_output_1_0_g101 = lerpResult25_g90.xy;
				float2 break3_g101 = temp_output_1_0_g101;
				float4 appendResult5_g101 = (float4(break3_g101.y , break3_g101.x , 0.0 , 0.0));
				float4 lerpResult2_g101 = lerp( float4( temp_output_1_0_g101, 0.0 , 0.0 ) , appendResult5_g101 , _PanningTex_InvertUV);
				float lerpResult8_g97 = lerp( 1.0 , texCoord2_g97.y , _EnableCustomData);
				float4 appendResult20_g97 = (float4(lerpResult8_g97 , 1.0 , 0.0 , 0.0));
				float4 appendResult19_g97 = (float4(1.0 , lerpResult8_g97 , 0.0 , 0.0));
				float4 lerpResult18_g97 = lerp( appendResult20_g97 , appendResult19_g97 , _CustomData_OffsetInvertUV);
				float2 temp_output_1_0_g99 = ( _PanningTex_ST.xy * lerpResult18_g97.xy );
				float2 break3_g99 = temp_output_1_0_g99;
				float4 appendResult5_g99 = (float4(break3_g99.y , break3_g99.x , 0.0 , 0.0));
				float4 lerpResult2_g99 = lerp( float4( temp_output_1_0_g99, 0.0 , 0.0 ) , appendResult5_g99 , _PanningTex_InvertUV);
				float2 panner1_g100 = ( 1.0 * _Time.y * (lerpResult2_g102).xy + ( (lerpResult2_g101).xy * (lerpResult2_g99).xy ));
				float2 texCoord9_g98 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode2_g98 = tex2D( _PanningTex, ( lerpResult17_g97.xy + panner1_g100 ), ddx( texCoord9_g98 ), ddy( texCoord9_g98 ) );
				float4 temp_output_41_0 = tex2DNode2_g98;
				float temp_output_76_0 = ( lerpResult15_g103 - ( temp_output_41_0.r * _CircleMask_Noise ) );
				float lerpResult79 = lerp( temp_output_76_0 , ( 1.0 - temp_output_76_0 ) , _Bicolor_OneMinusCircle);
				float smoothstepResult5_g106 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , ( lerpResult79 + temp_output_41_0 ).r);
				float lerpResult12_g106 = lerp( smoothstepResult5_g106 , ( 1.0 - smoothstepResult5_g106 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g106 = lerp( _ColorA , _ColorB , lerpResult12_g106);
				#ifdef _NOBICOLOR_ON
				float4 staticSwitch26 = float4( 0,0,0,0 );
				#else
				float4 staticSwitch26 = lerpResult4_g106;
				#endif
				
				float lerpResult10_g97 = lerp( 0.0 , texCoord1_g97.z , _EnableCustomData);
				float temp_output_7_0_g105 = ( _AlphaThreshold + lerpResult10_g97 );
				float temp_output_1_0_g105 = temp_output_76_0;
				float lerpResult9_g105 = lerp( temp_output_1_0_g105 , ( 1.0 - temp_output_1_0_g105 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g105 = smoothstep( temp_output_7_0_g105 , ( temp_output_7_0_g105 + _AlphaSmoothness ) , lerpResult9_g105);
				float4 screenPos = packedInput.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth1_g104 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth1_g104 = saturate( abs( ( screenDepth1_g104 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g104 = lerp( distanceDepth1_g104 , ( 1.0 - distanceDepth1_g104 ) , _DF_OneMinus);
				
				surfaceDescription.Color = ( lerpResult9_g97 * staticSwitch26 * packedInput.ase_color ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( smoothstepResult2_g105 * lerpResult3_g104 * packedInput.ase_color.a * _AlphaMul ) );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 texCoord1_g97 = packedInput.ase_texcoord;
				texCoord1_g97.xy = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult10_g97 = lerp( 0.0 , texCoord1_g97.z , _EnableCustomData);
				float temp_output_7_0_g105 = ( _AlphaThreshold + lerpResult10_g97 );
				float temp_output_3_0_g103 = _CircleMask_Radius;
				float2 texCoord2_g103 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult10_g103 = smoothstep( temp_output_3_0_g103 , ( temp_output_3_0_g103 + _CircleMask_Smoothness ) , distance( texCoord2_g103 , _CircleMask_Center ));
				float lerpResult15_g103 = lerp( ( 1.0 - smoothstepResult10_g103 ) , smoothstepResult10_g103 , _CircleMask_Invert);
				float2 texCoord2_g97 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g97 = lerp( 0.0 , texCoord2_g97.x , _EnableCustomData);
				float4 appendResult15_g97 = (float4(lerpResult11_g97 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g97 = (float4(0.0 , lerpResult11_g97 , 0.0 , 0.0));
				float4 lerpResult17_g97 = lerp( appendResult15_g97 , appendResult16_g97 , _CustomData_OffsetInvertUV);
				...
				float4 appendResult5_g102 = (float4(break3_g102.y , break3_g102.x , 0.0 , 0.0));
				float4 lerpResult2_g102 = lerp( float4( temp_output_1_0_g102, 0.0 , 0.0 ) , appendResult5_g102 , _PanningTex_InvertUV);
				float2 texCoord2_g90 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g90 = texCoord2_g90;
				float2 temp_output_18_0_g90 = float2( 0.5,0.5 );
				float temp_output_3_0_g90 = distance( temp_output_1_0_g90 , temp_output_18_0_g90 );
				float2 break6_g90 = ( temp_output_1_0_g90 + ( temp_output_18_0_g90 * float2( -1,-1 ) ) );
				...
				float4 lerpResult2_g99 = lerp( float4( temp_output_1_0_g99, 0.0 , 0.0 ) , appendResult5_g99 , _PanningTex_InvertUV);
				float2 panner1_g100 = ( 1.0 * _Time.y * (lerpResult2_g102).xy + ( (lerpResult2_g101).xy * (lerpResult2_g99).xy ));
				float2 texCoord9_g98 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode2_g98 = tex2D( _PanningTex, ( lerpResult17_g97.xy + panner1_g100 ), ddx( texCoord9_g98 ), ddy( texCoord9_g98 ) );
				float4 temp_output_41_0 = tex2DNode2_g98;
				float temp_output_76_0 = ( lerpResult15_g103 - ( temp_output_41_0.r * _CircleMask_Noise ) );
				float temp_output_1_0_g105 = temp_output_76_0;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 texCoord1_g97 = packedInput.ase_texcoord3;
				texCoord1_g97.xy = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult10_g97 = lerp( 0.0 , texCoord1_g97.z , _EnableCustomData);
				float temp_output_7_0_g105 = ( _AlphaThreshold + lerpResult10_g97 );
				float temp_output_3_0_g103 = _CircleMask_Radius;
				float2 texCoord2_g103 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult10_g103 = smoothstep( temp_output_3_0_g103 , ( temp_output_3_0_g103 + _CircleMask_Smoothness ) , distance( texCoord2_g103 , _CircleMask_Center ));
				float lerpResult15_g103 = lerp( ( 1.0 - smoothstepResult10_g103 ) , smoothstepResult10_g103 , _CircleMask_Invert);
				float2 texCoord2_g97 = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float lerpResult11_g97 = lerp( 0.0 , texCoord2_g97.x , _EnableCustomData);
				float4 appendResult15_g97 = (float4(lerpResult11_g97 , 0.0 , 0.0 , 0.0));
				float4 appendResult16_g97 = (float4(0.0 , lerpResult11_g97 , 0.0 , 0.0));
				float4 lerpResult17_g97 = lerp( appendResult15_g97 , appendResult16_g97 , _CustomData_OffsetInvertUV);
				...
				float4 appendResult5_g102 = (float4(break3_g102.y , break3_g102.x , 0.0 , 0.0));
				float4 lerpResult2_g102 = lerp( float4( temp_output_1_0_g102, 0.0 , 0.0 ) , appendResult5_g102 , _PanningTex_InvertUV);
				float2 texCoord2_g90 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g90 = texCoord2_g90;
				float2 temp_output_18_0_g90 = float2( 0.5,0.5 );
				float temp_output_3_0_g90 = distance( temp_output_1_0_g90 , temp_output_18_0_g90 );
				float2 break6_g90 = ( temp_output_1_0_g90 + ( temp_output_18_0_g90 * float2( -1,-1 ) ) );
				...
				float4 lerpResult2_g99 = lerp( float4( temp_output_1_0_g99, 0.0 , 0.0 ) , appendResult5_g99 , _PanningTex_InvertUV);
				float2 panner1_g100 = ( 1.0 * _Time.y * (lerpResult2_g102).xy + ( (lerpResult2_g101).xy * (lerpResult2_g99).xy ));
				float2 texCoord9_g98 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode2_g98 = tex2D( _PanningTex, ( lerpResult17_g97.xy + panner1_g100 ), ddx( texCoord9_g98 ), ddy( texCoord9_g98 ) );
				float4 temp_output_41_0 = tex2DNode2_g98;
				float temp_output_76_0 = ( lerpResult15_g103 - ( temp_output_41_0.r * _CircleMask_Noise ) );
				float temp_output_1_0_g105 = temp_output_76_0;
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;2455.57;647.1468;1.010709;True;False
Node;AmplifyShaderEditor.FunctionNode;83;-1427.878,-413.0821;Inherit;False;SF_PolarUV;5;;90;bc5d9a6ecd79c3041a2b8852c4a2b9cf;0;2;1;FLOAT2;0,0;False;18;FLOAT2;0.5,0.5;False;3;FLOAT4;0;FLOAT2;15;FLOAT2;16
Node;AmplifyShaderEditor.FunctionNode;88;-2183.559,-220.1885;Inherit;False;SF_PanningCustomData;8;;97;1838fadec439af641a6efc75ce73938c;0;0;4;FLOAT;0;FLOAT;3;FLOAT4;5;FLOAT4;6
Node;AmplifyShaderEditor.FunctionNode;41;-1260.483,-243.6919;Inherit;False;SF_PanningTexture;0;;98;b045855c7f4c7344eb8723194efc0969;0;6;3;SAMPLER2D;;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;2;COLOR;0;FLOAT;22
Node;AmplifyShaderEditor.FunctionNode;76;-933.2639,-139.1383;Inherit;False;SF_CircleMask;11;;103;fe677789fb780d34b8887718ca845428;0;5;17;FLOAT;0;False;1;FLOAT2;0,0;False;3;FLOAT;0;False;6;FLOAT2;0,0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-133.2884,519.1951;Inherit;False;Property;_AlphaMul;AlphaMul;32;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;89;-247.9179,241.6598;Inherit;False;SF_DepthFade;29;;104;adc458ead34511148bae829420de626c;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;23;-259.2705,322.1808;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;69;-203.5212,91.0482;Inherit;False;SF_AlphaSharp;25;;105;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;71.4875,134.8141;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;68;-360.259,-348.2452;Inherit;False;SF_Bicolor;17;;106;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;66;240.3699,226.7689;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;-773.5403,-506.0934;Inherit;False;Property;_Bicolor_OneMinusCircle;Bicolor_OneMinusCircle;23;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;209.5749,-212.1633;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;79;-649.5403,-413.0934;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;78;-880.5403,-403.0934;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;26;-95.90052,-259.2827;Inherit;False;Property;_NoBicolor;NoBicolor;24;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;53;-502.7219,-339.4308;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;41;5;83;0
WireConnection;41;8;88;6
WireConnection;41;14;88;5
WireConnection;76;17;41;0
WireConnection;69;1;76;0
WireConnection;69;6;88;0
WireConnection;11;0;69;0
WireConnection;11;1;89;0
WireConnection;11;2;23;4
WireConnection;11;3;61;0
WireConnection;68;1;53;0
WireConnection;66;0;11;0
WireConnection;16;0;88;3
...
ASEEND*/
//CHKSM=51D6B50752809BACCF58C829B6B26031DDE5ECC4