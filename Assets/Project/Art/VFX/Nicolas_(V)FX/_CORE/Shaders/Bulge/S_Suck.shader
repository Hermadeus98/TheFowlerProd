...
Shader "S_Suck"
{
	Properties
	{
		...
		[ASEBegin][Header(Circle Mask)]_CircleMask_Radius("CircleMask_Radius", Float) = 0.3
		...
		[ASEEnd]_Distort("Distort", Float) = 0.05
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float temp_output_3_0_g1 = _CircleMask_Radius;
				float2 texCoord2_g1 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult10_g1 = smoothstep( temp_output_3_0_g1 , ( temp_output_3_0_g1 + _CircleMask_Smoothness ) , distance( float4( texCoord2_g1, 0.0 , 0.0 ) , _CircleMask_Center ));
				float lerpResult15_g1 = lerp( ( 1.0 - smoothstepResult10_g1 ) , smoothstepResult10_g1 , _CircleMask_Invert);
				float2 texCoord11 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 fetchOpaqueVal9 = ASEHDSampleSceneColor(( ase_grabScreenPosNorm + float4( ( ( lerpResult15_g1 - ( 0.0 * _CircleMask_Noise ) ) * _Distort * packedInput.ase_color.a * ( ( texCoord11 * float2( 2,2 ) ) - float2( 1,1 ) ) ), 0.0 , 0.0 ) ).xy, 0.0, 1.0);
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;1822;741.5;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;18;-1063,-267.5;Inherit;False;SF_CircleMask;0;;1;fe677789fb780d34b8887718ca845428;0;5;17;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;3;FLOAT;0;False;6;FLOAT4;0,0,0,0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-944,-390.5;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;2,2;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;10;-275,-319.5;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-605,-150.5;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GrabScreenPosition;8;-654,-533.5;Inherit;False;0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-844,-132.5;Inherit;False;Property;_Distort;Distort;6;0;Create;True;0;0;0;False;0;False;0.05;-0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;13;-814,-348.5;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;1,1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;11;-1177,-418.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;16;-889,44.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=456C08EA5CE10C9E0E16F03048624E34F01596DA