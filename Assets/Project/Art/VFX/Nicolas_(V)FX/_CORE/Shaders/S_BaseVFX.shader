	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float3 vertexPos1_g22 = inputMesh.positionOS;
				float4 ase_clipPos1_g22 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g22));
				float4 screenPos1_g22 = ComputeScreenPos( ase_clipPos1_g22 , _ProjectionParams.x );
				o.ase_texcoord2 = screenPos1_g22;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord56 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g21 = texCoord56;
				...
				#endif
				float4 screenPos1_g22 = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm1 = screenPos1_g22 / screenPos1_g22.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g22 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g22 = saturate( abs( ( screenDepth1_g22 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g22 = lerp( distanceDepth1_g22 , ( 1.0 - distanceDepth1_g22 ) , _DF_OneMinus);
				
				surfaceDescription.Color = ( lerpResult4_g23 * packedInput.ase_color ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = saturate( ( staticSwitch39 * packedInput.ase_color.a * lerpResult3_g22 * _Alpha ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float4 ase_clipPos1_g22 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g22));
				float4 screenPos1_g22 = ComputeScreenPos( ase_clipPos1_g22 , _ProjectionParams.x );
				o.ase_texcoord1 = screenPos1_g22;
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord56 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g21 = texCoord56;
				float2 break3_g21 = temp_output_1_0_g21;
				float4 appendResult5_g21 = (float4(break3_g21.y , break3_g21.x , 0.0 , 0.0));
				float4 lerpResult2_g21 = lerp( float4( temp_output_1_0_g21, 0.0 , 0.0 ) , appendResult5_g21 , _InvertUV);
				...
				float staticSwitch39 = tex2DNode31.r;
				#endif
				float4 screenPos1_g22 = packedInput.ase_texcoord1;
				float4 ase_screenPosNorm1 = screenPos1_g22 / screenPos1_g22.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g22 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g22 = saturate( abs( ( screenDepth1_g22 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				float4 ase_clipPos1_g22 = TransformWorldToHClip( TransformObjectToWorld(vertexPos1_g22));
				float4 screenPos1_g22 = ComputeScreenPos( ase_clipPos1_g22 , _ProjectionParams.x );
				o.ase_texcoord4 = screenPos1_g22;
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord56 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g21 = texCoord56;
				float2 break3_g21 = temp_output_1_0_g21;
				float4 appendResult5_g21 = (float4(break3_g21.y , break3_g21.x , 0.0 , 0.0));
				float4 lerpResult2_g21 = lerp( float4( temp_output_1_0_g21, 0.0 , 0.0 ) , appendResult5_g21 , _InvertUV);
				...
				float staticSwitch39 = tex2DNode31.r;
				#endif
				float4 screenPos1_g22 = packedInput.ase_texcoord4;
				float4 ase_screenPosNorm1 = screenPos1_g22 / screenPos1_g22.w;
				ase_screenPosNorm1.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm1.z : ase_screenPosNorm1.z * 0.5 + 0.5;
				float screenDepth1_g22 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm1.xy ),_ZBufferParams);
				float distanceDepth1_g22 = saturate( abs( ( screenDepth1_g22 - LinearEyeDepth( ase_screenPosNorm1.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;803.058;359.847;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;23;-560.5001,-154.6;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;80960781fe3fefa45a7db4d31d880bf3;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;53;49.27698,464.2932;Inherit;False;SF_DepthFade;3;;22;adc458ead34511148bae829420de626c;0;1;6;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;39;115.9766,164.6231;Inherit;False;Property;_UseTextureAlpha;UseTextureAlpha;13;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;507.2771,211.3417;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;535.9767,-95.57703;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;52;722.7985,215.9535;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;44;175.9767,-66.57703;Inherit;False;SF_Bicolor;6;;23;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=9E5A061F6305CFAFCF556D12FCFAE1620EA9321D