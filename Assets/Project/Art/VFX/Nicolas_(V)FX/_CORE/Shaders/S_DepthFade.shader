...
Shader "DepthFade"
{
	Properties
	{
		...
		[ASEBegin][Header(DepthFade)]_DF_Distance("DF_Distance", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float temp_output_3_0_g9 = _CircleMask_Radius;
				float2 texCoord2_g9 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult10_g9 = smoothstep( temp_output_3_0_g9 , ( temp_output_3_0_g9 + _CircleMask_Smoothness ) , distance( texCoord2_g9 , _CircleMask_Center ));
				float lerpResult15_g9 = lerp( ( 1.0 - smoothstepResult10_g9 ) , smoothstepResult10_g9 , _CircleMask_Invert);
				float smoothstepResult5_g8 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , ( lerpResult15_g9 - ( 0.0 * _CircleMask_Noise ) ));
				float lerpResult12_g8 = lerp( smoothstepResult5_g8 , ( 1.0 - smoothstepResult5_g8 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g8 = lerp( _ColorA , _ColorB , lerpResult12_g8);
				
				float2 texCoord7_g7 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g7 = frac( texCoord7_g7 );
				float smoothstepResult3_g7 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g7.x);
				float smoothstepResult4_g7 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g7.x ));
				float smoothstepResult5_g7 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g7.y);
				float smoothstepResult6_g7 = smoothstep( _EdgeFadeV.z , _EdgeFadeV.w , ( 1.0 - break9_g7.y ));
				float lerpResult14_g7 = lerp( 1.0 , ( smoothstepResult3_g7 * smoothstepResult4_g7 * smoothstepResult5_g7 * smoothstepResult6_g7 ) , _EdgeFade_Enable);
				float temp_output_7_0_g6 = ( _AlphaThreshold + 0.0 );
				float4 screenPos = packedInput.ase_texcoord2;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth1_g5 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth1_g5 = saturate( abs( ( screenDepth1_g5 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g5 = lerp( distanceDepth1_g5 , ( 1.0 - distanceDepth1_g5 ) , _DF_OneMinus);
				float temp_output_1_0_g6 = lerpResult3_g5;
				float lerpResult9_g6 = lerp( temp_output_1_0_g6 , ( 1.0 - temp_output_1_0_g6 ) , _AlphaSharp_OneMinus);
				float smoothstepResult2_g6 = smoothstep( temp_output_7_0_g6 , ( temp_output_7_0_g6 + _AlphaSmoothness ) , lerpResult9_g6);
				
				surfaceDescription.Color = lerpResult4_g8.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( lerpResult14_g7 * smoothstepResult2_g6 );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord7_g7 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g7 = frac( texCoord7_g7 );
				float smoothstepResult3_g7 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g7.x);
				float smoothstepResult4_g7 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g7.x ));
				float smoothstepResult5_g7 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g7.y);
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float temp_output_3_0_g9 = _CircleMask_Radius;
				float2 texCoord2_g9 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult10_g9 = smoothstep( temp_output_3_0_g9 , ( temp_output_3_0_g9 + _CircleMask_Smoothness ) , distance( texCoord2_g9 , _CircleMask_Center ));
				float lerpResult15_g9 = lerp( ( 1.0 - smoothstepResult10_g9 ) , smoothstepResult10_g9 , _CircleMask_Invert);
				float smoothstepResult5_g8 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , ( lerpResult15_g9 - ( 0.0 * _CircleMask_Noise ) ));
				float lerpResult12_g8 = lerp( smoothstepResult5_g8 , ( 1.0 - smoothstepResult5_g8 ) , _Bicolor_OneMinus);
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord7_g7 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g7 = frac( texCoord7_g7 );
				float smoothstepResult3_g7 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g7.x);
				float smoothstepResult4_g7 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g7.x ));
				float smoothstepResult5_g7 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g7.y);
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;1262;488.5;1;True;False
Node;AmplifyShaderEditor.FunctionNode;12;-458,139.5;Inherit;False;SF_DepthFade;0;;5;adc458ead34511148bae829420de626c;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;13;-210,157.5;Inherit;False;SF_AlphaSharp;7;;6;1a46ba76a207bfe4e97ac05d03cb8401;0;2;1;FLOAT;0;False;6;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;14;32,309.5;Inherit;False;SF_EdgeFade;3;;7;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;10;-174,-67.5;Inherit;False;SF_Bicolor;17;;8;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;9;-553,-115.5;Inherit;False;SF_CircleMask;11;;9;fe677789fb780d34b8887718ca845428;0;5;17;FLOAT;0;False;1;FLOAT2;0,0;False;3;FLOAT;0;False;6;FLOAT2;0,0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;222,213.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=8A4D1C5AF443F8DF7EE631448A3280D1F6AF2AD5