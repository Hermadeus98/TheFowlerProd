...
Shader "WooshRework"
{
	Properties
	{
		...
		_PanningAlphaTex("PanningAlphaTex", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 temp_output_1_0_g14 = _PanningTex_ST.zw;
				float2 break3_g14 = temp_output_1_0_g14;
				float4 appendResult5_g14 = (float4(break3_g14.y , break3_g14.x , 0.0 , 0.0));
				float4 lerpResult2_g14 = lerp( float4( temp_output_1_0_g14, 0.0 , 0.0 ) , appendResult5_g14 , _PanningTex_InvertUV);
				float2 texCoord9_g10 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_output_1_0_g13 = texCoord9_g10;
				float2 break3_g13 = temp_output_1_0_g13;
				float4 appendResult5_g13 = (float4(break3_g13.y , break3_g13.x , 0.0 , 0.0));
				float4 lerpResult2_g13 = lerp( float4( temp_output_1_0_g13, 0.0 , 0.0 ) , appendResult5_g13 , _PanningTex_InvertUV);
				float2 temp_output_1_0_g11 = ( _PanningTex_ST.xy * float2( 1,1 ) );
				float2 break3_g11 = temp_output_1_0_g11;
				float4 appendResult5_g11 = (float4(break3_g11.y , break3_g11.x , 0.0 , 0.0));
				float4 lerpResult2_g11 = lerp( float4( temp_output_1_0_g11, 0.0 , 0.0 ) , appendResult5_g11 , _PanningTex_InvertUV);
				float2 panner1_g12 = ( 1.0 * _Time.y * (lerpResult2_g14).xy + ( (lerpResult2_g13).xy * (lerpResult2_g11).xy ));
				float4 tex2DNode2_g10 = tex2D( _PanningTex, ( float2( 0,0 ) + panner1_g12 ), ddx( texCoord9_g10 ), ddy( texCoord9_g10 ) );
				float4 temp_output_7_0 = tex2DNode2_g10;
				float smoothstepResult5_g15 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , temp_output_7_0.r);
				float lerpResult12_g15 = lerp( smoothstepResult5_g15 , ( 1.0 - smoothstepResult5_g15 ) , _Bicolor_OneMinus);
				float4 lerpResult4_g15 = lerp( _ColorA , _ColorB , lerpResult12_g15);
				#ifdef _NOBICOLOR_ON
				float4 staticSwitch10 = temp_output_7_0;
				#else
				float4 staticSwitch10 = lerpResult4_g15;
				#endif
				
				float2 texCoord7_g8 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g8 = frac( texCoord7_g8 );
				float smoothstepResult3_g8 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g8.x);
				float smoothstepResult4_g8 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g8.x ));
				float smoothstepResult5_g8 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g8.y);
				float smoothstepResult6_g8 = smoothstep( _EdgeFadeV.z , _EdgeFadeV.w , ( 1.0 - break9_g8.y ));
				float lerpResult14_g8 = lerp( 1.0 , ( smoothstepResult3_g8 * smoothstepResult4_g8 * smoothstepResult5_g8 * smoothstepResult6_g8 ) , _EdgeFade_Enable);
				float2 temp_output_9_0_g7 = _PanningAlphaTex_ST.xy;
				float2 texCoord4_g7 = packedInput.ase_texcoord1.xy * temp_output_9_0_g7 + ( _PanningAlphaTex_ST.zw - ( ( temp_output_9_0_g7 - float2( 1,1 ) ) / float2( 2,2 ) ) );
				float4 texCoord16_g7 = packedInput.ase_texcoord2;
				texCoord16_g7.xy = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 screenPos = packedInput.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth1_g9 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth1_g9 = saturate( abs( ( screenDepth1_g9 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DF_Distance ) ) );
				float lerpResult3_g9 = lerp( distanceDepth1_g9 , ( 1.0 - distanceDepth1_g9 ) , _DF_OneMinus);
				
				surfaceDescription.Color = ( staticSwitch10 * packedInput.ase_color ).rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( lerpResult14_g8 * tex2D( _PanningAlphaTex, ( texCoord4_g7 + ( texCoord16_g7.x * _PanningAlphaTex_ST.zw ) ) ) * lerpResult3_g9 * packedInput.ase_color.a ).r;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord7_g8 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g8 = frac( texCoord7_g8 );
				float smoothstepResult3_g8 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g8.x);
				float smoothstepResult4_g8 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g8.x ));
				float smoothstepResult5_g8 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g8.y);
				...
				float lerpResult14_g8 = lerp( 1.0 , ( smoothstepResult3_g8 * smoothstepResult4_g8 * smoothstepResult5_g8 * smoothstepResult6_g8 ) , _EdgeFade_Enable);
				float2 temp_output_9_0_g7 = _PanningAlphaTex_ST.xy;
				float2 texCoord4_g7 = packedInput.ase_texcoord.xy * temp_output_9_0_g7 + ( _PanningAlphaTex_ST.zw - ( ( temp_output_9_0_g7 - float2( 1,1 ) ) / float2( 2,2 ) ) );
				float4 texCoord16_g7 = packedInput.ase_texcoord1;
				texCoord16_g7.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord7_g8 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break9_g8 = frac( texCoord7_g8 );
				float smoothstepResult3_g8 = smoothstep( _EdgeFadeU.x , _EdgeFadeU.y , break9_g8.x);
				float smoothstepResult4_g8 = smoothstep( _EdgeFadeU.z , _EdgeFadeU.w , ( 1.0 - break9_g8.x ));
				float smoothstepResult5_g8 = smoothstep( _EdgeFadeV.x , _EdgeFadeV.y , break9_g8.y);
				...
				float lerpResult14_g8 = lerp( 1.0 , ( smoothstepResult3_g8 * smoothstepResult4_g8 * smoothstepResult5_g8 * smoothstepResult6_g8 ) , _EdgeFade_Enable);
				float2 temp_output_9_0_g7 = _PanningAlphaTex_ST.xy;
				float2 texCoord4_g7 = packedInput.ase_texcoord3.xy * temp_output_9_0_g7 + ( _PanningAlphaTex_ST.zw - ( ( temp_output_9_0_g7 - float2( 1,1 ) ) / float2( 2,2 ) ) );
				float4 texCoord16_g7 = packedInput.ase_texcoord4;
				texCoord16_g7.xy = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18900
-1920;0;1920;1019;1204.587;661.3921;1.141577;True;False
Node;AmplifyShaderEditor.FunctionNode;15;-679.6158,108.4193;Inherit;False;SF_PanningAlpha;12;;7;17e687cf74ec1c14fba2843a0e8105d3;0;3;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;9;FLOAT2;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;17;-327.7842,5.867615;Inherit;False;SF_EdgeFade;5;;8;2c737c027c7911941847cd940f44e2cc;0;1;8;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;19;-233.7842,218.8676;Inherit;False;SF_DepthFade;9;;9;adc458ead34511148bae829420de626c;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;20;-129.7842,-110.1324;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;7;-871.4001,-215.3001;Inherit;False;SF_PanningTexture;0;;10;b045855c7f4c7344eb8723194efc0969;0;6;3;SAMPLER2D;;False;5;FLOAT2;0,0;False;8;FLOAT2;0,0;False;6;FLOAT2;0,0;False;14;FLOAT2;1,1;False;7;FLOAT2;0,0;False;2;COLOR;0;FLOAT;22
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;152.2158,-163.1324;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;87.21582,60.86761;Inherit;False;4;4;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;10;-186.1159,-248.4804;Inherit;False;Property;_NoBicolor;NoBicolor;14;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;22;-461.4161,-308.2803;Inherit;False;SF_Bicolor;15;;15;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=535BA668D56755F338D9A9D345691FDD3CF159B6