...
Shader "S_State_Icon"
{
	Properties
	{
		...
		[ASEEnd]_Flicker_Max("Flicker_Max", Float) = 2
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float mulTime1_g1 = _TimeParameters.x * _Flicker_Speed;
				float temp_output_2_0_g1 = sin( ( mulTime1_g1 + ( 0.0 * _Flicker_Offset ) ) );
				float lerpResult12_g1 = lerp( _Flicker_Min , _Flicker_Max , ( ( temp_output_2_0_g1 + 1.0 ) / 2.0 ));
				float4 texCoord13 = packedInput.ase_texcoord1;
				texCoord13.xy = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.Alpha = ( packedInput.ase_color.a * tex2D( _MainTex, uv_MainTex ).r );
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;903;516.5;1;True;False
Node;AmplifyShaderEditor.SamplerNode;7;-487,14.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;a4e017d78a5ecf344bdb113f8259084b;a4e017d78a5ecf344bdb113f8259084b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;8;-435,-196.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-168,-70.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=28976B77D8426FF9B4AAFD16C96010D5A8DEDB82