...
Shader "S_State_Heal_Ring"
{
	Properties
	{
		...
		[ASEEnd]_DistortStrength("DistortStrength", Float) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord13_g2 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g39 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g2 * _DistortTex_ST.xy ));
				float4 tex2DNode24_g2 = tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g39 ) );
				float4 temp_cast_0 = (1.0).xxxx;
				float4 tex2DNode7 = tex2D( _MainTex, ( texCoord10 + (( ( ( tex2DNode24_g2 * 2.0 ) - temp_cast_0 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg ) );
				float smoothstepResult5_g1 = smoothstep( _BicolorThreshold , ( _BicolorThreshold + _BicolorSmoothness ) , tex2DNode7.r);
				...
				surfaceDescription.Alpha = ( tex2DNode7.r * packedInput.ase_color.a );
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord10 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord13_g2 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g39 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g2 * _DistortTex_ST.xy ));
				float4 tex2DNode24_g2 = tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g39 ) );
				float4 temp_cast_0 = (1.0).xxxx;
				float4 tex2DNode7 = tex2D( _MainTex, ( texCoord10 + (( ( ( tex2DNode24_g2 * 2.0 ) - temp_cast_0 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord13_g2 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner1_g39 = ( _TimeParameters.x * _DistortTex_ST.zw + ( texCoord13_g2 * _DistortTex_ST.xy ));
				float4 tex2DNode24_g2 = tex2D( _DistortTex, ( float2( 0,0 ) + panner1_g39 ) );
				float4 temp_cast_0 = (1.0).xxxx;
				float4 tex2DNode7 = tex2D( _MainTex, ( texCoord10 + (( ( ( tex2DNode24_g2 * 2.0 ) - temp_cast_0 ) * ( _DistortStrength + 0.0 ) * 1.0 )).rg ) );
...
/*ASEBEGIN
Version=18900
1920;231;1920;1019;1342;547.5;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1000,-174.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;9;-1023,-7.5;Inherit;False;SF_DistortTexture;7;;2;96c99f2862d31594fbaa887784570dd8;0;3;16;FLOAT;0;False;17;FLOAT;1;False;11;FLOAT2;0,0;False;2;FLOAT2;0;COLOR;25
Node;AmplifyShaderEditor.SimpleAddOpNode;11;-744,-149.5;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;7;-617,-116.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;b0932bac380e446478d5dfd3cfb255cc;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;13;-284,64.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;8;-211,-250.5;Inherit;False;SF_Bicolor;1;;1;8f1c0adb31a562646a4d2a8fec362420;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-124,-69.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C7B3AB8C967943487C687D94636BDD7A759D51A8