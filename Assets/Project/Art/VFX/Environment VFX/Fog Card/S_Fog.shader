...
Shader "S_Fog"
{
	Properties
	{
		...
		_OpacityFog("Opacity Fog", Range( 0 , 1)) = 1
		_PowerfOG("Power fOG", Range( 0 , 20)) = 2
		_ColorFog("Color Fog", Color) = (1,1,1,0)
		_IntensityGlobal("Intensity Global", Float) = 10
		_IntensityEmissive("Intensity Emissive", Range( 0 , 20)) = 1
		_SpeedFog("Speed Fog", Range( 0 , 20)) = 1
		_RoundIntensity("Round Intensity", Range( 0.3 , 10)) = 1
		_ScaleNoise("Scale Noise", Range( 0 , 10)) = 0
		[ASEEnd]_IntersectIntensity1("Intersect Intensity", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _OpacityFog;
			float _PowerfOG;
			float _RoundIntensity;
			float _IntensityGlobal;
			float _IntensityEmissive;
			float _IntersectIntensity1;
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_ScaleNoise).xx;
				float temp_output_21_0 = ( _TimeParameters.x * _SpeedFog );
				float2 temp_cast_1 = (temp_output_21_0).xx;
				float2 texCoord19 = packedInput.ase_texcoord1.xy * temp_cast_0 + temp_cast_1;
				float4 temp_cast_2 = (_PowerfOG).xxxx;
				float2 uv_TextureSample0 = packedInput.ase_texcoord1.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				float4 temp_cast_3 = (_RoundIntensity).xxxx;
				float4 temp_output_14_0 = ( pow( ( tex2D( _T_PerlinNoise, texCoord19 ) * _OpacityFog ) , temp_cast_2 ) * pow( tex2D( _TextureSample0, uv_TextureSample0 ) , temp_cast_3 ) * _IntensityGlobal );
				float4 temp_output_16_0 = ( temp_output_14_0 * _IntensityEmissive * _ColorFog );
				...
				float screenDepth44 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth44 = abs( ( screenDepth44 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _IntersectIntensity1 ) );
				float clampResult46 = clamp( distanceDepth44 , 0.0 , 1.0 );
				float4 lerpResult39 = lerp( color41 , temp_output_14_0 , clampResult46);
				
				surfaceDescription.Color = temp_output_16_0.rgb;
				surfaceDescription.Emission = temp_output_16_0.rgb;
				surfaceDescription.Alpha = lerpResult39.r;
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_21_0 = ( _TimeParameters.x * _SpeedFog );
				float2 temp_cast_1 = (temp_output_21_0).xx;
				float2 texCoord19 = packedInput.ase_texcoord.xy * temp_cast_0 + temp_cast_1;
				float4 temp_cast_2 = (_PowerfOG).xxxx;
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_21_0 = ( _TimeParameters.x * _SpeedFog );
				float2 temp_cast_1 = (temp_output_21_0).xx;
				float2 texCoord19 = packedInput.ase_texcoord3.xy * temp_cast_0 + temp_cast_1;
				float4 temp_cast_2 = (_PowerfOG).xxxx;
...
/*ASEBEGIN
Version=18900
7;42;1920;977;1846.169;332.0012;1.28465;True;True
Node;AmplifyShaderEditor.SimpleTimeNode;20;-1789.901,37.22177;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1879.901,233.2218;Inherit;False;Property;_SpeedFog;Speed Fog;7;0;Create;True;0;0;0;False;0;False;1;0.0125;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-1531.901,78.22177;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1570.326,-90.3956;Inherit;False;Property;_ScaleNoise;Scale Noise;9;0;Create;True;0;0;0;False;0;False;0;0.45;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-1375.901,-101.7782;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-1072.354,56.07028;Inherit;False;Property;_OpacityFog;Opacity Fog;2;0;Create;True;0;0;0;False;0;False;1;0.65;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-1135.354,-169.9297;Inherit;True;Property;_T_PerlinNoise;T_PerlinNoise;1;0;Create;True;0;0;0;False;0;False;-1;16e9cb8ed75e5b04598a91ae5277baab;16e9cb8ed75e5b04598a91ae5277baab;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;45;1404.077,762.5266;Float;False;Property;_IntersectIntensity1;Intersect Intensity;10;0;Create;True;0;0;0;False;0;False;0.2;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-978.3542,273.0703;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;bec5c7c44540e99458f061f069c981a8;b534afa6193c5664092e83d398d2f89b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;10;-931.3542,123.0703;Inherit;False;Property;_PowerfOG;Power fOG;3;0;Create;True;0;0;0;False;0;False;2;0.73;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-935.3262,516.6044;Inherit;False;Property;_RoundIntensity;Round Intensity;8;0;Create;True;0;0;0;False;0;False;1;0.3;0.3;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-780.3542,-68.92972;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.DepthFade;44;1994.641,726.5721;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;0.6361094,359.4413;Inherit;False;Property;_IntensityGlobal;Intensity Global;5;0;Create;True;0;0;0;False;0;False;10;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;24;-514.3262,345.6044;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;9;-497.3542,-108.9297;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;41;2424.962,343.8737;Inherit;False;Constant;_Color1;Color 1;11;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-214.3542,8.070282;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;46;2329.275,789.6677;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;39;2667.097,555.3226;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-358.3542,-291.9297;Inherit;False;Property;_IntensityEmissive;Intensity Emissive;6;0;Create;True;0;0;0;False;0;False;1;1.29;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;803.439,-222.0644;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.DynamicAppendNode;23;-1364.901,154.2218;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.ColorNode;40;1770.274,554.3817;Inherit;False;Constant;_Color0;Color 0;11;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;18;-144.3542,-226.9297;Inherit;False;Property;_ColorFog;Color Fog;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,0.927518,0.8431372,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EFAD98632C1BB569749951796931501EFBD290BD