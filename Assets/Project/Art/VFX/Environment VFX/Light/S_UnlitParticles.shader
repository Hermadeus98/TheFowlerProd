...
Shader "S_UnlitParticles"
{
	Properties
	{
		...
		[ASEEnd]_Eintensity("E intensity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = tex2DNode8.rgb;
				surfaceDescription.Emission = ( tex2DNode8 * _Eintensity ).rgb;
...
/*ASEBEGIN
Version=18900
1913;6;1920;1013;960;506.5;1;True;True
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-41,197.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;8;-576,34.5;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;7605196420d204945843c4c794c58361;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-239,231.5;Inherit;False;Property;_Eintensity;E intensity;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B06FE5DB0E309017EB44CAB6ECDC563DE8FB28AE