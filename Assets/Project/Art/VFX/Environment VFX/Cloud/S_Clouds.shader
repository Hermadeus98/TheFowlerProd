	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 rotatedValue14 = RotateAroundAxis( float3( 0,0,0 ), ase_worldPos, normalize( _Vector0.xyz ), _Vector0.w );
				float2 texCoord13 = packedInput.ase_texcoord1.xy * rotatedValue14.xy + float2( 0,0 );
				float4 tex2DNode10 = tex2D( T_PerlinNoise, texCoord13 );
				
				surfaceDescription.Color = tex2DNode10.rgb;
				surfaceDescription.Emission = tex2DNode10.rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float3 rotatedValue14 = RotateAroundAxis( float3( 0,0,0 ), ase_worldPos, normalize( _Vector0.xyz ), _Vector0.w );
				float2 texCoord13 = packedInput.ase_texcoord.xy * rotatedValue14.xy + float2( 0,0 );
				float4 tex2DNode10 = tex2D( T_PerlinNoise, texCoord13 );
...
/*ASEBEGIN
Version=18900
442;142;1920;999;1085.177;288.6268;1;True;True
Node;AmplifyShaderEditor.VoronoiNode;8;-453,-113.5;Inherit;False;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.SamplerNode;9;460,-193.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;7;-324,-165.5;Inherit;True;Simple;True;False;2;0;FLOAT2;1,1;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;16;-876,350.5;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.Vector4Node;15;-1132,273.5;Inherit;False;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RotateAboutAxisNode;14;-697.6108,329.6898;Inherit;False;True;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldPosInputsNode;11;-1134.159,31.24739;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;10;-375.8102,106.9843;Inherit;True;Global;T_PerlinNoise;T_PerlinNoise;1;0;Create;True;0;0;0;False;0;False;-1;3fa8e32cda9d0614cb7c23b94f38cc88;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;13;-697.0637,53.75262;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B7355151CAA3D30E3C872CEC682A36592B42951E