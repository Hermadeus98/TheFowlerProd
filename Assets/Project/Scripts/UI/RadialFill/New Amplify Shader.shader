	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Alpha = _Color0.a;
...
WireConnection;10;2;8;4
ASEEND*/
//CHKSM=E9E4EE1512BA29B1616DC0AEB74B0019C1B5C042