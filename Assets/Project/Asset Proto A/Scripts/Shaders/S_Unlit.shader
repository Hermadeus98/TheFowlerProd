...
Shader "S_Unlit"
{
	Properties
	{
		...
		_EIntensity("E Intensity", Range( 0 , 300)) = 0
		[ASEEnd]_ColorOverlay("Color Overlay", Color) = (1,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 uv_Diffuse_ = packedInput.ase_texcoord1.xy * _Diffuse__ST.xy + _Diffuse__ST.zw;
				
				surfaceDescription.Color = _ColorOverlay.rgb;
				surfaceDescription.Emission = ( _ColorOverlay * _EIntensity ).rgb;
				surfaceDescription.Alpha = tex2D( _Diffuse_, uv_Diffuse_ ).a;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_Diffuse_ = packedInput.ase_texcoord3.xy * _Diffuse__ST.xy + _Diffuse__ST.zw;
...
/*ASEBEGIN
Version=18900
7;36;1920;983;2300.431;763.8342;1.742786;True;True
Node;AmplifyShaderEditor.CommentaryNode;7;-1647.378,-405.6303;Inherit;False;1544.728;563.7712;Diffuse;8;18;10;6;5;4;3;2;1;Color Diffuse;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-409.9159,259.6144;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-766.1159,346.7144;Inherit;False;Property;_EIntensity;E Intensity;1;0;Create;True;0;0;0;False;0;False;0;0;0;300;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;18;-1597.378,-200.0942;Inherit;True;Property;_Diffuse_;Diffuse_;0;0;Create;True;0;0;0;False;0;False;-1;794827149dd2931478dfdff3f40f2564;0e4bec2a477c341438444c932cfcc7e2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-685.6689,-262.359;Inherit;False;Property;_ColorOverlay;Color Overlay;2;0;Create;True;0;0;0;False;0;False;1,0,0,0;0.6981132,0.6981132,0.6981132,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;0;2;18;4
ASEEND*/
//CHKSM=E82D360A72DD89A8BBB20068CADCEFD79D5AAF14