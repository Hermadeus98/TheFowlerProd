...
Shader "S_MultiMaterial"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_T_WaterMask("T_WaterMask", 2D) = "white" {}
		[ASEEnd]_VCRedIntensity("VCRedIntensity", Range( 0 , 2)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 color14 = IsGammaSpace() ? float4(0.191124,1,0,0) : float4(0.0304063,1,0,0);
				float2 uv_T_WaterMask = packedInput.ase_texcoord5.xy * _T_WaterMask_ST.xy + _T_WaterMask_ST.zw;
				float4 tex2DNode16 = tex2D( _T_WaterMask, uv_T_WaterMask );
				float clampResult19 = clamp( ( ( packedInput.ase_color.r * 2.25 ) - ( tex2DNode16.b + tex2DNode16.b ) ) , 0.0 , 1.0 );
				float lerpResult20 = lerp( packedInput.ase_color.r , clampResult19 , _VCRedIntensity);
				float clampResult29 = clamp( lerpResult20 , 0.0 , 1.0 );
				float4 lerpResult11 = lerp( color13 , color14 , clampResult29);
				
				surfaceDescription.Albedo = lerpResult11.rgb;
...
/*ASEBEGIN
Version=18900
-3;35;1920;989;1533.767;-772.7197;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;22;-1103.651,880.9396;Inherit;False;1759.068;825.6521;Vertex Color Dirt Mask;9;16;20;21;19;17;15;18;12;29;;1,1,1,1;0;0
Node;AmplifyShaderEditor.VertexColorNode;12;-752.4684,930.9396;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-1059.356,1304.035;Inherit;True;Property;_T_WaterMask;T_WaterMask;0;0;Create;True;0;0;0;False;0;False;-1;a818fd3f1bf67324ea499b7e827439d9;a818fd3f1bf67324ea499b7e827439d9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;18;-669.3453,1249.993;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-496.9058,1067.506;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2.25;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;17;-277.2058,1216.656;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-43.7496,1411.665;Inherit;False;Property;_VCRedIntensity;VCRedIntensity;1;0;Create;True;0;0;0;False;0;False;0.5;1.332;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;19;-69.02819,1114.506;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;20;190.325,950.4366;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;-142.1771,194.8152;Inherit;False;Constant;_Color1;Color 1;0;0;Create;True;0;0;0;False;0;False;0.191124,1,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;13;-148.7604,-138.7558;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;29;489.862,1032.355;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;11;734.0137,194.9954;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=054DD8BB11F1B2B9227B9114CE5F2DB60DE206BB